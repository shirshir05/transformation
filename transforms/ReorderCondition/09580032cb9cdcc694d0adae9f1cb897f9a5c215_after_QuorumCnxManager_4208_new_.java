...
public class QuorumCnxManager {
    ...
    public class Listener extends Thread {
        ...
        public void run() {
            ...
            if (!shutdown) {
                LOG.fatal("election any longer: " + "As I'm leaving the listener thread, " + "I won't be able to participate in leader " + self.quorumPeers.get(self.getId()).electionAddr);
            }
        }
