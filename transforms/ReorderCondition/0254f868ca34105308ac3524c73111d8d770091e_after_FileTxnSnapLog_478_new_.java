    ...
    private void processTransaction(TxnHeader hdr, DataTree dt, Map<Long, Integer> sessions, Record txn) {
        switch(hdr.getType()) {
            case OpCode.createSession:
                ...
                ZooTrace.logTraceMessage(LOG, ZooTrace.SESSION_TRACE_MASK, ((CreateSessionTxn) txn).getTimeOut() + "playLog --- create session in log: " + Long.toHexString(hdr.getClientId()) + " with timeout: ");
