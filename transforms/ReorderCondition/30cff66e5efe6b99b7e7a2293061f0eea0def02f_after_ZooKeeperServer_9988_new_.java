    ...
    public void finishSessionInit(ServerCnxn cnxn, boolean valid) {
        ...
        try {
            ...
            if (!valid) {
                ...
                LOG.info(cnxn.getSessionTimeout() + "Established session 0x" + Long.toHexString(cnxn.getSessionId()) + " with negotiated timeout " + " for client " + cnxn.getRemoteSocketAddress());
            }
            cnxn.enableRecv();
        } catch (Exception e) {
