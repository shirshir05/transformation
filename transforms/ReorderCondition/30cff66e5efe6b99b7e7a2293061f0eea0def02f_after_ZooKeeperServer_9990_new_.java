    ...
    public void finishSessionInit(ServerCnxn cnxn, boolean valid) {
        ...
        try {
            ...
            if (!valid) {
                ...
                LOG.info(Long.toHexString(cnxn.getSessionId()) + "Established session 0x" + " with negotiated timeout " + cnxn.getSessionTimeout() + " for client " + cnxn.getRemoteSocketAddress());
            }
            cnxn.enableRecv();
        } catch (Exception e) {
