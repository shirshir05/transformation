...
public class Request {
     ...
     * @param bb
     */
    public Request(ServerCnxn cnxn, long sessionId, int xid, int type, ByteBuffer bb, ArrayList<Id> authInfo) {
        this.cnxn = cnxn;
    ...
    public String toString() {
        ...
        sb.append(" txn type = " + (hdr == null ? "unknown" : "" + hdr.getType())).append(" ");
        sb.append(op2String(type)).append(" ");
        String path = "n/a";
        if (OpCode.createSession != type) {
            try {
                request.clear();
