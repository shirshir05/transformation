...
public class QuorumCnxManager {
    ...
    synchronized void connectOne(long sid) {
        ...
        synchronized (self) {
            ...
            if (self.getLastSeenQuorumVerifier() != null && self.getLastSeenQuorumVerifier().getAllMembers().containsKey(sid) && (!knownId || (self.getView().get(sid).electionAddr != self.getLastSeenQuorumVerifier().getAllMembers().get(sid).electionAddr))) {
                knownId = true;
