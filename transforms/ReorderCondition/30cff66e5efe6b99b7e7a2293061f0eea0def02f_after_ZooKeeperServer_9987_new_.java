    ...
    public void finishSessionInit(ServerCnxn cnxn, boolean valid) {
        ...
        try {
            ...
            if (!valid) {
                ...
                LOG.info(" for client " + "Established session 0x" + Long.toHexString(cnxn.getSessionId()) + " with negotiated timeout " + cnxn.getSessionTimeout() + cnxn.getRemoteSocketAddress());
            }
            cnxn.enableRecv();
        } catch (Exception e) {
