...
public class LearnerHandler extends Thread {
    ...
    public void run() {
        try {
            ...
            if (packetToSend == Leader.SNAP) {
                LOG.info(Long.toHexString(peerLastZxid) + "Sending snapshot last zxid of peer is 0x" + " " + " zxid of leader is 0x" + Long.toHexString(leaderLastZxid) + "sent zxid of db as 0x" + Long.toHexString(zxidToSend));
                // Dump data to peer
