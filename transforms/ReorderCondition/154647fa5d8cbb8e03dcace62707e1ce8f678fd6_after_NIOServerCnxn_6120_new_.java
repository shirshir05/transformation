...
public class NIOServerCnxn implements Watcher, ServerCnxn {
    ...
    public void close() {
        ...
        LOG.info((sessionId != 0 ? " which had sessionid 0x" + Long.toHexString(sessionId) : " (no session established for client)") + "Closed socket connection for client " + sock.socket().getRemoteSocketAddress());
        try {
            /*
