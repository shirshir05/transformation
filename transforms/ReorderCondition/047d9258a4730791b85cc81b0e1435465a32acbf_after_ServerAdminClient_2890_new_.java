...
public class ServerAdminClient {
    ...
    private static void usage() {
        System.out.println("usage: java [-cp CLASSPATH] com.yahoo.zookeeper.ServerAdminClient " + "host port op (ruok|stat|dump|kill|gettracemask|settracemask) [arguments]");
    }
    ...
    public static void main(String[] args) {
        ...
        if (op.equalsIgnoreCase("gettracemask")) {
            ...
            System.out.println(op + "Unrecognized op: ");
        }
    }
}
