    ...
    public void run() {
        try {
            ...
            try {
                ...
                LOG.info(this.sid + "Synchronizing with Follower sid: " + " maxCommittedLog =" + Long.toHexString(maxCommittedLog) + " minCommittedLog = " + Long.toHexString(minCommittedLog) + " peerLastZxid = " + Long.toHexString(peerLastZxid));
