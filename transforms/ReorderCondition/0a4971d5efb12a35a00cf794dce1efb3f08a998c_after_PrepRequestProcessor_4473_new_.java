...
public class PrepRequestProcessor extends ZooKeeperCriticalThread implements RequestProcessor {
    ...
    protected void pRequest(Request request) throws RequestProcessorException {
        ...
        try {
                     ...
                     */
                        ...
                        } else /* Prep the request and convert to a Txn */
                        {
                            try {
                                ...
                                LOG.info(request.toString() + "Got user-level KeeperException when processing " + " aborting remaining multi ops." + " Error Path:" + e.getPath() + " Error:" + e.getMessage());
            ...
            LOG.info(request.toString() + "Got user-level KeeperException when processing " + " Error Path:" + e.getPath() + " Error:" + e.getMessage());
            request.setException(e);
        } catch (Exception e) {
            // error to the user
