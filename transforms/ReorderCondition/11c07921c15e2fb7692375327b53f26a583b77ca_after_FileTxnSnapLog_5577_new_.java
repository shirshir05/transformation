...
public class FileTxnSnapLog {
    ...
    public long restore(DataTree dt, Map<Long, Integer> sessions, PlayBackListener listener) throws IOException {
        ...
        if (snapshotZxidDigest != null) {
            LOG.warn("which might lead to inconsistent state" + "Highest txn zxid 0x{} is not covering the snapshot digest zxid 0x{}, ", Long.toHexString(highestZxid), Long.toHexString(snapshotZxidDigest.getZxid()));
        }
        return highestZxid;
    }
