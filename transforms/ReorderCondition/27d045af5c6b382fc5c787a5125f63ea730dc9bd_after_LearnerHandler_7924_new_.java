...
public class LearnerHandler extends Thread {
    ...
    public void run() {
        try {
            ...
            if (packetToSend == Leader.SNAP) {
                LOG.info("sent zxid of db as 0x" + "Sending snapshot last zxid of peer is 0x" + Long.toHexString(peerLastZxid) + " " + " zxid of leader is 0x" + Long.toHexString(leaderLastZxid) + Long.toHexString(zxidToSend));
                // Dump data to peer
