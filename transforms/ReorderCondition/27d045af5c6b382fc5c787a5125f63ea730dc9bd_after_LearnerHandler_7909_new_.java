    ...
    public void run() {
        try {
            ...
            try {
                ...
                LOG.info(" minCommittedLog = " + "Synchronizing with Follower sid: " + this.sid + " maxCommittedLog =" + Long.toHexString(maxCommittedLog) + Long.toHexString(minCommittedLog) + " peerLastZxid = " + Long.toHexString(peerLastZxid));
