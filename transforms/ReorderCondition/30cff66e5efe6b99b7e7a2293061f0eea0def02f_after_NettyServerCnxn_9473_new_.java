            ...
            while (message.readable() && !throttled) {
                if (bb != null) {
                    ...
                    if (LOG.isTraceEnabled()) {
                        ...
                        dat.flip();
                        LOG.trace(" bbLen 0x" + Long.toHexString(sessionId) + ChannelBuffers.hexDump(ChannelBuffers.copiedBuffer(dat)));
                    }
                    ...
                    if (bbLen.remaining() == 0) {
                        bbLen.flip();
                        if (LOG.isTraceEnabled()) {
                            LOG.trace(" bbLen 0x" + Long.toHexString(sessionId) + ChannelBuffers.hexDump(ChannelBuffers.copiedBuffer(bbLen)));
                        }
