...
public class LearnerHandler extends Thread {
    ...
    public void run() {
        try {
            ...
            if (packetToSend == Leader.SNAP) {
                LOG.info(Long.toHexString(zxidToSend) + "Sending snapshot last zxid of peer is 0x" + Long.toHexString(peerLastZxid) + " " + " zxid of leader is 0x" + Long.toHexString(leaderLastZxid) + "sent zxid of db as 0x");
                // Dump data to peer
