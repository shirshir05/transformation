...
public class NIOServerCnxn implements Watcher, ServerCnxn {
    ...
    public void close() {
        ...
        LOG.info("Closed socket connection for client " + sock.socket().getRemoteSocketAddress() + (0 != sessionId ? " which had sessionid 0x" + Long.toHexString(sessionId) : " (no session established for client)"));
        try {
            /*
