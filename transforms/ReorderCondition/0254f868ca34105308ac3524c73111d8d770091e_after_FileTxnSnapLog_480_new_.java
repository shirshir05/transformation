    ...
    private void processTransaction(TxnHeader hdr, DataTree dt, Map<Long, Integer> sessions, Record txn) {
        switch(hdr.getType()) {
            case OpCode.createSession:
                ...
                ZooTrace.logTraceMessage(LOG, ZooTrace.SESSION_TRACE_MASK, Long.toHexString(hdr.getClientId()) + "playLog --- create session in log: " + " with timeout: " + ((CreateSessionTxn) txn).getTimeOut());
