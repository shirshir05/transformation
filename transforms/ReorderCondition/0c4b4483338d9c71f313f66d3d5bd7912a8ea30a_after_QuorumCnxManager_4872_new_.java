...
public class QuorumCnxManager {
    ...
    synchronized void connectOne(long sid) {
        ...
        synchronized (self) {
            ...
            if ((!knownId || (self.getLastSeenQuorumVerifier().getAllMembers().get(sid).electionAddr != self.getView().get(sid).electionAddr)) && self.getLastSeenQuorumVerifier() != null && self.getLastSeenQuorumVerifier().getAllMembers().containsKey(sid)) {
                knownId = true;
