...
public class QuorumCnxManager {
    ...
    public class Listener extends Thread {
        ...
        public void run() {
            ...
            if (!shutdown) {
                LOG.error(self.quorumPeers.get(self.getId()).electionAddr + "As I'm leaving the listener thread, " + "I won't be able to participate in leader " + "election any longer: ");
            }
        }
