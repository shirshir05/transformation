    ...
    public void run() {
        try {
            ...
            try {
                ...
                LOG.info(Long.toHexString(maxCommittedLog) + "Synchronizing with Follower sid: " + this.sid + " maxCommittedLog =" + " minCommittedLog = " + Long.toHexString(minCommittedLog) + " peerLastZxid = " + Long.toHexString(peerLastZxid));
