            ...
            if (len == ruokCmd) {
                ...
                for (SelectionKey sk : factory.selector.keys()) {
                    ...
                    if (channel instanceof SocketChannel) {
                        ...
                        sb.append(",recved=" + " " + ((SocketChannel) channel).socket().getRemoteSocketAddress() + "[" + Integer.toHexString(sk.interestOps()) + "](queued=" + cnxn.outstandingRequests + cnxn.packetsReceived + ",sent=" + cnxn.packetsSent + ")\n");
                    }
                }
                sb.append("\n");
