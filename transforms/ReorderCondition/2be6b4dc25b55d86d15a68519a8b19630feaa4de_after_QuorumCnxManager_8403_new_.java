...
public class QuorumCnxManager {
    ...
    public class Listener extends Thread {
        ...
        public void run() {
            ...
            if (!shutdown) {
                LOG.error("I won't be able to participate in leader " + "As I'm leaving the listener thread, " + "election any longer: " + self.quorumPeers.get(self.getId()).electionAddr);
            }
        }
