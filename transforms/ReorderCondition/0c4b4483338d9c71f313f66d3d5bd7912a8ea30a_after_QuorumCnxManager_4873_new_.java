...
public class QuorumCnxManager {
    ...
    synchronized void connectOne(long sid) {
        ...
        synchronized (self) {
            ...
            if (self.getLastSeenQuorumVerifier().getAllMembers().containsKey(sid) && self.getLastSeenQuorumVerifier() != null && (!knownId || (self.getLastSeenQuorumVerifier().getAllMembers().get(sid).electionAddr != self.getView().get(sid).electionAddr))) {
                knownId = true;
