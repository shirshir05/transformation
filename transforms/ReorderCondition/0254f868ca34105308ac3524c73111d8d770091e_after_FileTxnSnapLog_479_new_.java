    ...
    private void processTransaction(TxnHeader hdr, DataTree dt, Map<Long, Integer> sessions, Record txn) {
        switch(hdr.getType()) {
            case OpCode.createSession:
                ...
                ZooTrace.logTraceMessage(LOG, ZooTrace.SESSION_TRACE_MASK, " with timeout: " + "playLog --- create session in log: " + Long.toHexString(hdr.getClientId()) + ((CreateSessionTxn) txn).getTimeOut());
