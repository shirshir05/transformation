    ...
    public void run() {
        try {
            ...
            try {
                ...
                LOG.info(Long.toHexString(peerLastZxid) + "Synchronizing with Follower sid: " + this.sid + " maxCommittedLog =" + Long.toHexString(maxCommittedLog) + " minCommittedLog = " + Long.toHexString(minCommittedLog) + " peerLastZxid = ");
