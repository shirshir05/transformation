...
public class PrepRequestProcessor extends Thread implements RequestProcessor {
     ...
     */
    void rollbackPendingChanges(long var0, HashMap<String, ChangeRecord> pendingChangeRecords) {
        synchronized (zks.outstandingChanges) {
            ...
            long firstZxid = 0;
            if (!empty) {
                firstZxid = zks.outstandingChanges.get(0).var0;
            }
