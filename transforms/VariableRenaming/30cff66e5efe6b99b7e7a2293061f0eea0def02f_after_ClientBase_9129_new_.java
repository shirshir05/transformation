...
public abstract class ClientBase extends ZKTestCase {
    ...
    static ServerCnxnFactory createNewServerInstance(File dataDir, ServerCnxnFactory var1, String hostPort, int maxCnxns) throws IOException, InterruptedException {
        ZooKeeperServer zks = new ZooKeeperServer(dataDir, dataDir, 3000);
        final int PORT = getPort(hostPort);
        if (var1 == null) {
            var1 = ServerCnxnFactory.createFactory(PORT, maxCnxns);
        }
        var1.startup(zks);
