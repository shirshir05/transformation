...
public class ZooInspectorManagerImpl implements ZooInspectorManager {
    ...
    public Pair<Map<String, List<String>>, Map<String, String>> getConnectionPropertiesTemplate() {
        ...
        Map<String, String> var1 = new LinkedHashMap<String, String>();
        var1.put(CONNECT_STRING, "Connect String");
        var1.put(SESSION_TIMEOUT, "Session Timeout");
        var1.put(DATA_ENCRYPTION_MANAGER, "Data Encryption Manager");
        return new Pair<Map<String, List<String>>, Map<String, String>>(template, var1);
    }
