...
public class ClientCnxn {
    ...
    class SendThread extends Thread {
        ...
        void readConnectResult() throws IOException {
            ...
            ConnectResponse var2 = new ConnectResponse();
            var2.deserialize(bbia, "connect");
            int sessionTimeout = var2.getTimeOut();
            if (sessionTimeout <= 0) {
            ...
            sessionId = var2.getSessionId();
            sessionPasswd = var2.getPasswd();
