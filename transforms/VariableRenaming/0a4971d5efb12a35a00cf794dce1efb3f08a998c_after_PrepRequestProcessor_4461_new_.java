...
public class PrepRequestProcessor extends ZooKeeperCriticalThread implements RequestProcessor {
    ...
    protected void pRequest(Request request) throws RequestProcessorException {
        ...
        try {
            switch(request.type) {
                ...
                case OpCode.multi:
                     ...
                     */
                        ...
                        ByteBuffer var25 = ByteBuffer.wrap(baos.toByteArray());
                        txns.add(new Txn(type, var25.array()));
                    }
            ...
            ByteBuffer var25 = request.request;
            if (var25 != null) {
                var25.rewind();
                while (var25.hasRemaining()) {
                    sb.append(Integer.toHexString(var25.get() & 0xff));
                }
            } else {
