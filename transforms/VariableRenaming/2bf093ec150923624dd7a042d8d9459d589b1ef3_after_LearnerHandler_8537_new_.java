        ...
        try {
            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.PING:
                        // Process the touches
                        ByteArrayInputStream var21 = new ByteArrayInputStream(qp.getData());
                        DataInputStream dis = new DataInputStream(var21);
                        ...
                        break;
                    case Leader.REVALIDATE:
                        var21 = new ByteArrayInputStream(qp.getData());
                        dis = new DataInputStream(var21);
                        long id = dis.readLong();
                        int to = dis.readInt();
