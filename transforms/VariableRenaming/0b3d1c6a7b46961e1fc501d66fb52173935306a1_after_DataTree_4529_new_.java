        ...
        try {
            ...
            switch(header.getType()) {
                case OpCode.create:
                    ...
                    var3 = "Create transaction for " + createTxn.getPath();
                ...
                case OpCode.delete:
                    ...
                    var3 = "Delete transaction for " + deleteTxn.getPath();
                    rc.path = deleteTxn.getPath();
                    deleteNode(deleteTxn.getPath(), header.getZxid());
                    break;
                case OpCode.setData:
                    SetDataTxn setDataTxn = (SetDataTxn) txn;
                    var3 = "Set data transaction for " + setDataTxn.getPath() + " to new value=" + Arrays.toString(setDataTxn.getData());
                    rc.stat = setData(setDataTxn.getPath(), setDataTxn.getData(), setDataTxn.getVersion(), header.getZxid(), header.getTime());
                    break;
                case OpCode.setACL:
                    SetACLTxn setACLTxn = (SetACLTxn) txn;
                    var3 = "Set ACL transaction for " + setACLTxn.getPath();
                ...
                case OpCode.check:
                    ...
                    var3 = "Check Version transaction for " + checkTxn.getPath() + " and version=" + checkTxn.getVersion();
                    rc.path = checkTxn.getPath();
                    break;
                case OpCode.multi:
                    MultiTxn multiTxn = (MultiTxn) txn;
                    List<Txn> txns = multiTxn.getTxns();
                    var3 = "Multi transaction with " + txns.size() + " operations";
