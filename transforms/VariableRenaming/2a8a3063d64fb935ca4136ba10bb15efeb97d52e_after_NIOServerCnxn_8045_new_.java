...
public class NIOServerCnxn implements Watcher, ServerCnxn {
    ...
    private class MonitorCommand extends CommandThread {
        ...
        public void commandRun() {
            ...
            ServerStats var1 = zk.serverStats();
            print("version", Version.getFullVersion());
            print("avg_latency", var1.getAvgLatency());
            print("max_latency", var1.getMaxLatency());
            print("min_latency", var1.getMinLatency());
            print("packets_received", var1.getPacketsReceived());
            print("packets_sent", var1.getPacketsSent());
            print("outstanding_requests", var1.getOutstandingRequests());
            print("server_state", var1.getServerState());
