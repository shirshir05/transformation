    ...
    protected void pRequest2Txn(int type, long zxid, Request request, Record record) throws KeeperException {
        ...
        switch(type) {
            case OpCode.create:
                ...
                int var6 = path.lastIndexOf('/');
                if (var6 == -1 || path.indexOf('\0') != -1 || failCreate) {
                ...
                String parentPath = path.substring(0, var6);
            ...
            case OpCode.delete:
                ...
                var6 = path.lastIndexOf('/');
                if (var6 == -1 || path.indexOf('\0') != -1 || zks.getZKDatabase().isSpecialPath(path)) {
                    throw new KeeperException.BadArgumentsException(path);
                }
                parentPath = path.substring(0, var6);
