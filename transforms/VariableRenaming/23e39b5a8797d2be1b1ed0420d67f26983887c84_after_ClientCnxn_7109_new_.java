...
class ClientCnxn {
    ...
    public ReplyHeader submitRequest(RequestHeader h, Record request, Record var2, WatchRegistration watchRegistration) throws InterruptedException {
        ReplyHeader r = new ReplyHeader();
        Packet packet = queuePacket(h, r, request, var2, null, null, null, watchRegistration);
        synchronized (packet) {
