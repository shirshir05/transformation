    ...
    public boolean connect(Properties connectionProps) {
        try {
            if (this.zooKeeper == null) {
                ...
                String var2 = connectionProps.getProperty(SESSION_TIMEOUT);
                String encryptionManager = connectionProps.getProperty(DATA_ENCRYPTION_MANAGER);
                if (connectString == null || var2 == null) {
                ...
                this.var2 = Integer.valueOf(var2);
                this.zooKeeper = new ZooKeeperRetry(connectString, Integer.valueOf(var2), new Watcher() {
