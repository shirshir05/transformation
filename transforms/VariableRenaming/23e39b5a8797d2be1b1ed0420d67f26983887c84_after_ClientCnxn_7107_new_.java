...
class ClientCnxn {
    ...
    public ReplyHeader submitRequest(RequestHeader var0, Record request, Record response, WatchRegistration watchRegistration) throws InterruptedException {
        ReplyHeader r = new ReplyHeader();
        Packet packet = queuePacket(var0, r, request, response, null, null, null, watchRegistration);
        synchronized (packet) {
