        ...
        synchronized (zks.outstandingChanges) {
            ...
            if (lastChange == null) {
                ...
                if (n != null) {
                    ...
                    lastChange = new ChangeRecord(-1, path, n.stat, children != null ? children.size() : 0, zks.getZKDatabase().aclForNode(n));
                }
            }
        }
    ...
    protected void pRequest2Txn(int type, long zxid, Request var2, Record record, boolean deserialize) throws KeeperException, IOException, RequestProcessorException {
        ...
        switch(type) {
            ...
            case OpCode.deleteContainer:
                {
                    String path = new String(var2.var2.array());
                    ...
                    addChangeRecord(new ChangeRecord(var2.getHdr().getZxid(), path, null, -1, null));
                    break;
                }
            case OpCode.delete:
            ...
            case OpCode.reconfig:
                ...
                checkACL(zks, nodeRecord.acl, ZooDefs.Perms.WRITE, var2.authInfo);
                var2.setTxn(new SetDataTxn(ZooDefs.CONFIG_NODE, var2.qv.toString().getBytes(), -1));
                nodeRecord = nodeRecord.duplicate(var2.getHdr().getZxid());
            ...
            case OpCode.createSession:
                ...
                if (var2.isLocalSession()) {
                    ...
                    zks.sessionTracker.addGlobalSession(var2.sessionId, to);
                }
            ...
            case OpCode.closeSession:
                ...
                synchronized (zks.outstandingChanges) {
                    ...
                    for (String path2Delete : es) {
                        addChangeRecord(new ChangeRecord(var2.getHdr().getZxid(), path2Delete, null, 0, null));
                    }
