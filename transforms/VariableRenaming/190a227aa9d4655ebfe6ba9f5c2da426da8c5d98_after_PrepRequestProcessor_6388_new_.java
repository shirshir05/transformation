        ...
        switch(type) {
            ...
            case OpCode.closeSession:
                ...
                synchronized (zks.outstandingChanges) {
                    ...
                    Set<String> var48 = zks.getZKDatabase().getEphemerals(request.sessionId);
                    ...
                    if (ZooKeeperServer.isCloseSessionTxnEnabled()) {
                        request.setTxn(new CloseSessionTxn(new ArrayList<String>(var48)));
                    }
