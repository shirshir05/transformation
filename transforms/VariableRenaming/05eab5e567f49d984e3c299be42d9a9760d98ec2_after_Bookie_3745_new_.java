...
public class Bookie extends Thread {
    ...
    public void addEntry(ByteBuffer entry, AddCallback cb, Object ctx, byte[] var3) throws IOException, BookieException {
        long ledgerId = entry.getLong();
        LedgerDescriptor handle = getHandle(ledgerId, false, var3);
        if (!masterKeys.get(ledgerId).equals(ByteBuffer.wrap(var3))) {
