...
public class DataTree {
    ...
    public ProcessTxnResult processTxn(TxnHeader var0, Record txn) {
        ProcessTxnResult rc = new ProcessTxnResult();
        String debug = "";
        try {
            rc.clientId = var0.getClientId();
            rc.cxid = var0.getCxid();
            rc.zxid = var0.getZxid();
            rc.type = var0.getType();
            rc.err = 0;
            rc.multiResult = null;
            ...
            switch(var0.getType()) {
                case OpCode.create:
                    ...
                    createNode(createTxn.getPath(), createTxn.getData(), createTxn.getAcl(), createTxn.getEphemeral() ? var0.getClientId() : 0, createTxn.getParentCVersion(), var0.getZxid(), var0.getTime());
                    break;
                case OpCode.delete:
                    DeleteTxn deleteTxn = (DeleteTxn) txn;
                    debug = "Delete transaction for " + deleteTxn.getPath();
                    rc.path = deleteTxn.getPath();
                    deleteNode(deleteTxn.getPath(), var0.getZxid());
                    break;
                case OpCode.setData:
                    SetDataTxn setDataTxn = (SetDataTxn) txn;
                    debug = "Set data transaction for " + setDataTxn.getPath() + " to new value=" + Arrays.toString(setDataTxn.getData());
                    rc.stat = setData(setDataTxn.getPath(), setDataTxn.getData(), setDataTxn.getVersion(), var0.getZxid(), var0.getTime());
                    break;
                case OpCode.setACL:
                ...
                case OpCode.closeSession:
                    killSession(var0.getClientId(), var0.getZxid());
                    break;
                case OpCode.error:
                ...
                case OpCode.multi:
                    ...
                    for (Txn subtxn : txns) {
                        ...
                        TxnHeader subHdr = new TxnHeader(var0.getClientId(), var0.getCxid(), var0.getZxid(), var0.getTime(), subtxn.getType());
