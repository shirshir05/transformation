            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.REVALIDATE:
                        ...
                        break;
                    case Leader.REQUEST:
                        var13 = ByteBuffer.wrap(qp.getData());
                        sessionId = var13.getLong();
                        cxid = var13.getInt();
                        type = var13.getInt();
                        var13 = var13.slice();
                        if (type == OpCode.sync) {
                            leader.zk.submitRequest(new LearnerSyncRequest(this, sessionId, cxid, type, var13, qp.getAuthinfo()));
                        } else {
                            Request si = new Request(null, sessionId, cxid, type, var13, qp.getAuthinfo());
                            si.setOwner(this);
