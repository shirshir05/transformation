    ...
    class SendWorker extends Thread {
        ...
        public void run() {
            try {
                ...
                LOG.error("Failed to send last message. Shutting down thread.", var1);
                this.finish();
            }
            try {
                while (running && !shutdown && sock != null) {
                    ...
                    try {
                        ...
                        LOG.warn("Interrupted while waiting for message on queue", var1);
                    }
                }
            } catch (Exception var1) {
                LOG.warn("Exception when using channel: for id " + sid + " my id = " + self.getId() + " error = " + var1);
            }
            this.finish();
