...
public class DataTree {
    ...
    public String createNode(String path, byte[] data, List<ACL> acl, long ephemeralOwner, long zxid, long time) throws KeeperException.NoNodeException, KeeperException.NodeExistsException {
        ...
        StatPersisted var9 = new StatPersisted();
        var9.setCtime(time);
        var9.setMtime(time);
        var9.setCzxid(zxid);
        var9.setMzxid(zxid);
        ...
        var9.setVersion(0);
        var9.setAversion(0);
        var9.setEphemeralOwner(ephemeralOwner);
        ...
        synchronized (parent) {
            ...
            int cver = parent.var9.getCversion();
            cver++;
            parent.var9.setCversion(cver);
            parent.var9.setPzxid(zxid);
            Long longval = convertAcls(acl);
            DataNode child = new DataNode(parent, data, longval, var9);
