        ...
        switch(type) {
            ...
            case OpCode.reconfig:
                ...
                if (newMembers != null) {
                    ...
                    Map<Long, QuorumServer> var31 = new HashMap<Long, QuorumServer>(lastSeenQV.getAllMembers());
                    try {
                        ...
                        if (joiningServers != null) {
                            for (String joiner : joiningServers) {
                                ...
                                for (QuorumServer nqs : var31.values()) {
                                    if (qs.id == nqs.id) {
                                        continue;
                                    }
                                ...
                                var31.remove(qs.id);
                                var31.put(Long.valueOf(qs.id), qs);
                            }
                        }
                    } catch (ConfigException e) {
                        throw new KeeperException.BadArgumentsException("Reconfiguration failed");
                    }
                    request.qv = new QuorumMaj(var31);
                    request.qv.setVersion(request.getHdr().getZxid());
                }
