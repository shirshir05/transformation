...
public class DataTree {
     ...
     */
    public String createNode(String path, byte[] data, List<ACL> acl, long ephemeralOwner, long zxid, long var5) throws KeeperException.NoNodeException, KeeperException.NodeExistsException {
