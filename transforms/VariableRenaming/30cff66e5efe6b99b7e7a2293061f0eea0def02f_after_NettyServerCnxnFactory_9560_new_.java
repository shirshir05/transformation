...
public class NettyServerCnxnFactory extends ServerCnxnFactory {
    ...
    public void closeAll() {
        ...
        synchronized (cnxns) {
            ...
            for (NettyServerCnxn var0 : cnxns.toArray(new NettyServerCnxn[cnxns.size()])) {
                try {
                    var0.close();
                } catch (Exception e) {
                    LOG.warn("Ignoring exception closing cnxn sessionid 0x" + Long.toHexString(var0.getSessionId()), e);
                }
            }
        }
        if (LOG.isDebugEnabled()) {
