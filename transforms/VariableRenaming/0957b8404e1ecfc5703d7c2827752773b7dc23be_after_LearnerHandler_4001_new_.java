...
public class LearnerHandler extends Thread {
    ...
    public String toString() {
        ...
        var0.append("LearnerHandler ").append(sock);
        var0.append(" tickOfLastAck:").append(tickOfLastAck());
        var0.append(" synced?:").append(synced());
        var0.append(" queuedPacketLength:").append(queuedPackets.size());
