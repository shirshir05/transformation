...
public class QuorumPeerConfig {
    ...
    public void checkValidity() throws IOException, ConfigException {
        if (quorumVerifier.getVotingMembers().size() > 1) {
            ...
            File var0 = new File(dataDir, "myid");
            if (!var0.exists()) {
                throw new IllegalArgumentException(var0.toString() + " file is missing");
            }
            BufferedReader br = new BufferedReader(new FileReader(var0));
            String myIdString;
            try {
