...
public class FileTxnSnapLog {
     ...
     */
    private void processTransaction(TxnHeader hdr, DataTree dt, Map<Long, Integer> var2, Record txn) {
        switch(hdr.getType()) {
            case OpCode.createSession:
                var2.put(hdr.getClientId(), ((CreateSessionTxn) txn).getTimeOut());
