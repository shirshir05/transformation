        ...
        try {
            switch(request.type) {
                ...
                case OpCode.setACL:
                    ...
                    break;
                case OpCode.check:
                    CheckVersionRequest var5 = new CheckVersionRequest();
                    ZooKeeperServer.byteBuffer2Record(request.request, var5);
                    pRequest2Txn(request.type, zks.getNextZxid(), request, var5);
                    break;
                case OpCode.multi:
