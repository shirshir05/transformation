...
public class DataTree {
    ...
    public ProcessTxnResult processTxn(TxnHeader header, Record var1) {
        ...
        try {
            ...
            switch(header.getType()) {
                case OpCode.create:
                    CreateTxn createTxn = (CreateTxn) var1;
                    ...
                    break;
                case OpCode.delete:
                    DeleteTxn deleteTxn = (DeleteTxn) var1;
                    debug = "Delete transaction for " + deleteTxn.getPath();
                    rc.path = deleteTxn.getPath();
                    deleteNode(deleteTxn.getPath(), header.getZxid());
                    break;
                case OpCode.setData:
                    SetDataTxn setDataTxn = (SetDataTxn) var1;
                    ...
                    break;
                case OpCode.setACL:
                    SetACLTxn setACLTxn = (SetACLTxn) var1;
                ...
                case OpCode.closeSession:
                    ...
                    break;
                case OpCode.error:
                    ErrorTxn errTxn = (ErrorTxn) var1;
                    rc.err = errTxn.getErr();
                    break;
                case OpCode.check:
                    CheckVersionTxn checkTxn = (CheckVersionTxn) var1;
                    debug = "Check Version transaction for " + checkTxn.getPath() + " and version=" + checkTxn.getVersion();
                    rc.path = checkTxn.getPath();
                    break;
                case OpCode.multi:
                    MultiTxn multiTxn = (MultiTxn) var1;
