...
public class FastLeaderElection implements Election {
     ...
     * current vote.
     */
    protected boolean totalOrderPredicate(long newId, long newZxid, long newEpoch, long curId, long curZxid, long var5) {
        LOG.debug("id: {}, proposed id: {}, zxid: 0x{}, proposed zxid: 0x{}", newId, curId, Long.toHexString(newZxid), Long.toHexString(curZxid));
        if (self.getQuorumVerifier().getWeight(newId) == 0) {
            return false;
        }
        return ((newEpoch > var5) || ((newEpoch == var5) && ((newZxid > curZxid) || ((newZxid == curZxid) && (newId > curId)))));
    }
