...
public abstract class ClientBase extends ZKTestCase {
    ...
    static ServerCnxnFactory createNewServerInstance(File var0, ServerCnxnFactory factory, String hostPort, int maxCnxns) throws IOException, InterruptedException {
        ZooKeeperServer zks = new ZooKeeperServer(var0, var0, 3000);
