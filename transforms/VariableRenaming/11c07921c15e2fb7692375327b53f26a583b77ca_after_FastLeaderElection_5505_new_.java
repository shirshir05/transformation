...
public class FastLeaderElection implements Election {
     ...
     * current vote.
     */
    protected boolean totalOrderPredicate(long newId, long var1, long newEpoch, long curId, long curZxid, long curEpoch) {
        LOG.debug("id: {}, proposed id: {}, zxid: 0x{}, proposed zxid: 0x{}", newId, curId, Long.toHexString(var1), Long.toHexString(curZxid));
        if (self.getQuorumVerifier().getWeight(newId) == 0) {
            return false;
        }
        return ((newEpoch > curEpoch) || ((newEpoch == curEpoch) && ((var1 > curZxid) || ((var1 == curZxid) && (newId > curId)))));
    }
