...
public class DigestAuthenticationProvider implements AuthenticationProvider {
    ...
    static public String generateDigest(String var0) throws NoSuchAlgorithmException {
        String[] parts = var0.split(":", 2);
        byte[] digest = MessageDigest.getInstance("SHA1").digest(var0.getBytes());
