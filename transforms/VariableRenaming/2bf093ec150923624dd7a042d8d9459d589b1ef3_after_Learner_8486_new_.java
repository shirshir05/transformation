            ...
            outerLoop: while (self.isRunning()) {
                ...
                switch(qp.getType()) {
                    case Leader.PROPOSAL:
                        ...
                        BinaryInputArchive var8 = BinaryInputArchive.getArchive(new ByteArrayInputStream(qp.getData()));
                        pif.rec = SerializeUtils.deserializeTxn(var8, pif.hdr);
                    ...
                    case Leader.INFORM:
                        ...
                        var8 = BinaryInputArchive.getArchive(new ByteArrayInputStream(qp.getData()));
                        Record txn = SerializeUtils.deserializeTxn(var8, hdr);
