...
public abstract class ClientBase extends ZKTestCase {
    ...
    protected static ZooKeeperServer getServer(ServerCnxnFactory fac) {
        ...
        FieldAccessor<ServerCnxnFactory, ZooKeeperServer> var1 = new FieldAccessor<ServerCnxnFactory, ZooKeeperServer>("zkServer", ServerCnxnFactory.class);
        ZooKeeperServer zs = var1.get(fac);
        return zs;
    }
