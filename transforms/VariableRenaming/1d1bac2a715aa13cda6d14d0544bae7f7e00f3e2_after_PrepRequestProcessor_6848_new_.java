    ...
    protected void pRequest2Txn(int type, long zxid, Request request, Record record) throws KeeperException {
        ...
        switch(type) {
            case OpCode.create:
                ...
                request.txn = new CreateTxn(var5, createRequest.getData(), listACL, createMode.isEphemeral(), newCversion);
                ...
                addChangeRecord(new ChangeRecord(request.hdr.getZxid(), var5, s, 0, listACL));
                break;
            case OpCode.delete:
                zks.sessionTracker.checkSession(request.sessionId, request.getOwner());
            ...
            case OpCode.setACL:
                ...
                version = currentVersion + 1;
                request.txn = new SetACLTxn(var5, listACL, version);
                nodeRecord = nodeRecord.duplicate(request.hdr.getZxid());
