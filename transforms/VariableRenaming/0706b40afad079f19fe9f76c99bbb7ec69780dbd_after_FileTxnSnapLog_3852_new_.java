...
public class FileTxnSnapLog {
     ...
     * @throws IOException
     */
    public long restore(DataTree dt, Map<Long, Integer> var1, PlayBackListener listener) throws IOException {
        long deserializeResult = snapLog.deserialize(dt, var1);
        ...
        if (-1L == deserializeResult) {
            ...
            if (trustEmptyDB) {
                 ...
                 *       or use Map on save() */
                save(dt, (ConcurrentHashMap<Long, Integer>) var1, false);
        ...
        try {
            while (true) {
                ...
                try {
                    processTransaction(hdr, dt, var1, itr.getTxn());
