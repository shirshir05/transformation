    ...
    private class MonitorCommand extends CommandThread {
        ...
        public void commandRun() {
            ...
            if (osMbean != null && osMbean instanceof UnixOperatingSystemMXBean) {
                UnixOperatingSystemMXBean var3 = (UnixOperatingSystemMXBean) osMbean;
                print("open_file_descriptor_count", var3.getOpenFileDescriptorCount());
                print("max_file_descriptor_count", var3.getMaxFileDescriptorCount());
            }
