...
public class QuorumPeerConfig {
    ...
    public void parseProperties(Properties zkProp) throws IOException, ConfigException {
        ...
        if (servers.size() == 0) {
            ...
            LearnerType var27 = observers.containsKey(serverId) ? LearnerType.OBSERVER : LearnerType.PARTICIPANT;
            if (var27 != peerType) {
                LOG.warn("Peer type from servers list (" + var27 + ") doesn't match peerType (" + peerType + "). Defaulting to servers list.");
                peerType = var27;
            }
        }
    }
