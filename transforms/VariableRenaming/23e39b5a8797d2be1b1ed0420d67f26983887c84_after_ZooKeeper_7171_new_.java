...
public class ZooKeeper {
     ...
     */
    public String create(String var0, byte[] data, List<ACL> acl, int flags) throws KeeperException, InterruptedException {
        RequestHeader h = new RequestHeader();
        ...
        if (r.getErr() != 0) {
            throw KeeperException.create(r.getErr(), var0);
        }
