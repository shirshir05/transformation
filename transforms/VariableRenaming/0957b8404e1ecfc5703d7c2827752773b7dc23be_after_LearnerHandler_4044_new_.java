            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.REQUEST:
                        ...
                        bb = bb.slice();
                        if (type == OpCode.sync) {
                            leader.zk.submitRequest(new LearnerSyncRequest(this, sessionId, var15, type, bb, qp.getAuthinfo()));
                        } else {
                            Request si = new Request(null, sessionId, var15, type, bb, qp.getAuthinfo());
                            si.setOwner(this);
