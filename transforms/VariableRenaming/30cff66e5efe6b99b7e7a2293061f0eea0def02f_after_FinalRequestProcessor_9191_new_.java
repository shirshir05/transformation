                ...
                case OpCode.getData:
                    {
                        ...
                        DataNode var17 = zks.getZKDatabase().getNode(getDataRequest.getPath());
                        if (var17 == null) {
                ...
                case OpCode.getChildren:
                    {
                        ...
                        DataNode var17 = zks.getZKDatabase().getNode(getChildrenRequest.getPath());
                        if (var17 == null) {
                            throw new KeeperException.NoNodeException();
                        }
                        Long aclG;
                ...
                case OpCode.getChildren2:
                    {
                        ...
                        Stat stat = new Stat();
                        DataNode var17 = zks.getZKDatabase().getNode(getChildren2Request.getPath());
                        if (var17 == null) {
                            throw new KeeperException.NoNodeException();
                        }
                        Long aclG;
