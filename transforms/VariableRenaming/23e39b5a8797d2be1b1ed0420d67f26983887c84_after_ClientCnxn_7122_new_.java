...
class ClientCnxn {
    ...
    Packet queuePacket(RequestHeader h, ReplyHeader r, Record request, Record response, AsyncCallback cb, String path, Object var6, WatchRegistration watchRegistration) {
        Packet packet = null;
        synchronized (outgoingQueue) {
