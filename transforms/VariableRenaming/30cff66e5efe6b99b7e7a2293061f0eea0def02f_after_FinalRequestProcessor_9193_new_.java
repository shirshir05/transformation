        ...
        try {
            ...
            switch(request.type) {
                ...
                case OpCode.setData:
                    {
                        lastOp = "SETD";
                        rsp = new SetDataResponse(rc.var19);
                        err = Code.get(rc.err);
                        break;
                    }
                case OpCode.setACL:
                    {
                        lastOp = "SETA";
                        rsp = new SetACLResponse(rc.var19);
                        err = Code.get(rc.err);
                        break;
                    }
                ...
                case OpCode.exists:
                    {
                        ...
                        Stat var19 = zks.getZKDatabase().statNode(path, existsRequest.getWatch() ? cnxn : null);
                        rsp = new ExistsResponse(var19);
                        break;
                    }
                case OpCode.getData:
                    {
                        ...
                        Stat var19 = new Stat();
                        byte[] b = zks.getZKDatabase().getData(getDataRequest.getPath(), var19, getDataRequest.getWatch() ? cnxn : null);
                        rsp = new GetDataResponse(b, var19);
                        break;
                    }
                ...
                case OpCode.getACL:
                    {
                        ...
                        Stat var19 = new Stat();
                        List<ACL> acl = zks.getZKDatabase().getACL(getACLRequest.getPath(), var19);
                        rsp = new GetACLResponse(acl, var19);
                        break;
                    }
                ...
                case OpCode.getChildren2:
                    {
                        ...
                        PrepRequestProcessor.checkACL(zks, zks.getZKDatabase().convertLong(aclG), ZooDefs.Perms.READ, request.authInfo);
                        List<String> children = zks.getZKDatabase().getChildren(getChildren2Request.getPath(), var19, getChildren2Request.getWatch() ? cnxn : null);
                        rsp = new GetChildren2Response(children, var19);
                        break;
                    }
            }
