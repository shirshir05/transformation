        ...
        try {
            ...
            if (learnerInfoData != null) {
                if (learnerInfoData.length == 8) {
                    ...
                    LearnerInfo var3 = new LearnerInfo();
                    ZooKeeperServer.byteBuffer2Record(ByteBuffer.wrap(learnerInfoData), var3);
                    this.sid = var3.getServerid();
                    this.version = var3.getProtocolVersion();
                }
            } else {
