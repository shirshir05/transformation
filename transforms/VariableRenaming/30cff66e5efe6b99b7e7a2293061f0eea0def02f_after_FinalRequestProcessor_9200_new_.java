        ...
        try {
            ...
            switch(request.type) {
                ...
                case OpCode.getChildren:
                    {
                        lastOp = "GETC";
                        GetChildrenRequest var26 = new GetChildrenRequest();
                        ZooKeeperServer.byteBuffer2Record(request.request, var26);
                        DataNode n = zks.getZKDatabase().getNode(var26.getPath());
                        if (n == null) {
                            throw new KeeperException.NoNodeException();
                        }
                        Long aclG;
                        ...
                        List<String> children = zks.getZKDatabase().getChildren(var26.getPath(), null, var26.getWatch() ? cnxn : null);
