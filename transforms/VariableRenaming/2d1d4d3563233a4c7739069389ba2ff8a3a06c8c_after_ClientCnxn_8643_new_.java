                ...
                while (true) {
                    ...
                    if (event instanceof WatcherEvent) {
                        ...
                        if (p.cb == null) {
                            ...
                            GetDataResponse var6 = (GetDataResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, path, p.ctx, var6.getData(), var6.getStat());
                            } else {
                                cb.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetACLResponse) {
                            ACLCallback cb = (ACLCallback) p.cb;
                            GetACLResponse var6 = (GetACLResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, path, p.ctx, var6.getAcl(), var6.getStat());
                            } else {
                                cb.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetChildrenResponse) {
                            ChildrenCallback cb = (ChildrenCallback) p.cb;
                            GetChildrenResponse var6 = (GetChildrenResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, path, p.ctx, var6.getChildren());
                            } else {
                                cb.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof CreateResponse) {
                            StringCallback cb = (StringCallback) p.cb;
                            CreateResponse var6 = (CreateResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, path, p.ctx, var6.getPath());
                            } else {
                                cb.processResult(rc, path, p.ctx, null);
                            }
