...
public class QuorumCnxManager {
     ...
     */
    synchronized private boolean connectOne(long var0, InetSocketAddress electionAddr) {
    ...
    synchronized void connectOne(long sid) {
        ...
        synchronized (self) {
            ...
            if (self.getLastSeenQuorumVerifier() != null && self.getLastSeenQuorumVerifier().getAllMembers().containsKey(sid) && (!knownId || (self.getLastSeenQuorumVerifier().getAllMembers().get(sid).electionAddr != self.getView().get(sid).electionAddr))) {
                knownId = true;
