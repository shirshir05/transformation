    ...
    public void run() {
        try {
            ...
            if (learnerType == LearnerType.PARTICIPANT) {
                ...
                long var8 = leader.getEpochToPropose(this.getSid(), lastAcceptedEpoch);
                if (this.getVersion() < 0x10000) {
                    ...
                    QuorumPacket newEpochPacket = new QuorumPacket(Leader.LEADERINFO, ZxidUtils.makeZxid(var8, 0), ver, null);
