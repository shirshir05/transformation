        ...
        switch(type) {
            ...
            case OpCode.closeSession:
                ...
                synchronized (zks.outstandingChanges) {
                    ...
                    for (String var50 : es) {
                        if (digestEnabled) {
                            parentPath = getParentPathAndValidate(var50);
                        ...
                        nodeRecord = new ChangeRecord(request.getHdr().getZxid(), var50, null, 0, null);
                        nodeRecord.precalculatedDigest = precalculateDigest(DigestOpCode.REMOVE, var50);
                        addChangeRecord(nodeRecord);
                    }
