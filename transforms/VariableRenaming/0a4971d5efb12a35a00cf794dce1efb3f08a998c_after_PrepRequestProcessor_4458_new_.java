    ...
    protected void pRequest(Request request) throws RequestProcessorException {
        ...
        try {
                     ...
                     */
                        ...
                        } else /* Prep the request and convert to a Txn */
                        {
                            try {
                                ...
                                ke = var22;
                                type = OpCode.error;
                                txn = new ErrorTxn(var22.code().intValue());
                                LOG.info("Got user-level KeeperException when processing " + request.toString() + " aborting remaining multi ops." + " Error Path:" + var22.getPath() + " Error:" + var22.getMessage());
                                request.setException(var22);
            ...
            if (request.getHdr() != null) {
                ...
                request.setTxn(new ErrorTxn(var22.code().intValue()));
            }
            LOG.info("Got user-level KeeperException when processing " + request.toString() + " Error Path:" + var22.getPath() + " Error:" + var22.getMessage());
            request.setException(var22);
        } catch (Exception var22) {
            // error to the user
            LOG.error("Failed to process " + request, var22);
