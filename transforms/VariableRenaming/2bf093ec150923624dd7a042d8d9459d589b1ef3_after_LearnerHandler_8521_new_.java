    ...
    public void run() {
        try {
            ...
            try {
                ...
                var5 = leader.startForwarding(this, updates);
                if (peerLastZxid == var5) {
            ...
            QuorumPacket newLeaderQP = new QuorumPacket(Leader.NEWLEADER, var5, null, null);
            ...
            if (packetToSend == Leader.SNAP) {
                LOG.info("Sending snapshot last zxid of peer is 0x" + Long.toHexString(peerLastZxid) + " " + " zxid of leader is 0x" + Long.toHexString(var5) + "sent zxid of db as 0x" + Long.toHexString(zxidToSend));
                // Dump data to peer
