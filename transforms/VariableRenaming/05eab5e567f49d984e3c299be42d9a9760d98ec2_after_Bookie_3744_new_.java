...
public class Bookie extends Thread {
    ...
    public void addEntry(ByteBuffer entry, AddCallback cb, Object var2, byte[] masterKey) throws IOException, BookieException {
        ...
        try {
            ...
            queue.add(new QueueEntry(entry, ledgerId, entryId, cb, var2));
        } finally {
            putHandle(handle);
        }
    }
