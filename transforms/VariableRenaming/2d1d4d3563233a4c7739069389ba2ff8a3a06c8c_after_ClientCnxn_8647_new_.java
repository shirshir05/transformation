                ...
                while (true) {
                    ...
                    if (event instanceof WatcherEvent) {
                        ...
                        if (p.cb == null) {
                            ...
                            GetDataResponse var10 = (GetDataResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, path, p.ctx, var10.getData(), var10.getStat());
                            } else {
                                cb.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetACLResponse) {
                            ACLCallback cb = (ACLCallback) p.cb;
                            GetACLResponse var10 = (GetACLResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, path, p.ctx, var10.getAcl(), var10.getStat());
                            } else {
                                cb.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetChildrenResponse) {
                            ChildrenCallback cb = (ChildrenCallback) p.cb;
                            GetChildrenResponse var10 = (GetChildrenResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, path, p.ctx, var10.getChildren());
                            } else {
                                cb.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof CreateResponse) {
                            StringCallback cb = (StringCallback) p.cb;
                            CreateResponse var10 = (CreateResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, path, p.ctx, var10.getPath());
                            } else {
                                cb.processResult(rc, path, p.ctx, null);
                            }
