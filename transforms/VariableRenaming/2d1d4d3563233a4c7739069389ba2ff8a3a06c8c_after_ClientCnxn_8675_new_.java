...
public class ClientCnxn {
    ...
    class SendThread extends Thread {
        ...
        void readResponse() throws IOException {
            timeout = readTimeout / 2;
            ByteBufferInputStream bbis = new ByteBufferInputStream(incomingBuffer);
            BinaryInputArchive var1 = BinaryInputArchive.getArchive(bbis);
            ReplyHeader r = new ReplyHeader();
            r.deserialize(var1, "header");
            if (r.getXid() == -2) {
            ...
            if (r.getXid() == -1) {
                ...
                event.deserialize(var1, "response");
            ...
            if (p.response != null && r.getErr() == 0) {
                p.response.deserialize(var1, "response");
            }
            p.finished = true;
            finishPacket(p);
        }
