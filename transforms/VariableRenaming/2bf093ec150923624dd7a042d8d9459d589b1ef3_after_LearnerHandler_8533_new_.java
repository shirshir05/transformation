            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.REVALIDATE:
                        ...
                        break;
                    case Leader.REQUEST:
                        var17 = ByteBuffer.wrap(qp.getData());
                        sessionId = var17.getLong();
                        cxid = var17.getInt();
                        type = var17.getInt();
                        var17 = var17.slice();
                        Request si;
                        if (type == OpCode.sync) {
                            si = new LearnerSyncRequest(this, sessionId, cxid, type, var17, qp.getAuthinfo());
                        } else {
                            si = new Request(null, sessionId, cxid, type, var17, qp.getAuthinfo());
                        }
                        si.setOwner(this);
