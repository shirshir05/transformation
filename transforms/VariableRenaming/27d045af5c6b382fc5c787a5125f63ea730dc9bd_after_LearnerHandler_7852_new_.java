    ...
    public void run() {
        try {
            ...
            try {
                ...
                var16 = leader.startForwarding(this, updates);
                if (peerLastZxid == var16) {
            ...
            QuorumPacket newLeaderQP = new QuorumPacket(Leader.NEWLEADER, var16, null, null);
            ...
            if (packetToSend == Leader.SNAP) {
                LOG.info("Sending snapshot last zxid of peer is 0x" + Long.toHexString(peerLastZxid) + " " + " zxid of leader is 0x" + Long.toHexString(var16) + "sent zxid of db as 0x" + Long.toHexString(zxidToSend));
                // Dump data to peer
