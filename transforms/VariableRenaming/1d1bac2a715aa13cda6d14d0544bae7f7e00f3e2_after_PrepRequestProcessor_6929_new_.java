    ...
    private boolean fixupACL(List<Id> authInfo, List<ACL> acl) {
        ...
        while (it.hasNext()) {
            ...
            if (id.getScheme().equals("world") && id.getId().equals("anyone")) {
                ...
                for (Id cid : authInfo) {
                    AuthenticationProvider var9 = ProviderRegistry.getProvider(cid.getScheme());
                    if (var9 == null) {
                        LOG.error("Missing AuthenticationProvider for " + cid.getScheme());
                    } else if (var9.isAuthenticated()) {
                        authIdValid = true;
                ...
                AuthenticationProvider var9 = ProviderRegistry.getProvider(id.getScheme());
                if (var9 == null) {
                    return false;
                }
                if (!var9.isValid(id.getId())) {
                    return false;
                }
            }
        }
