                    ...
                    try {
                        ...
                        if (joiningServers != null) {
                            for (String joiner : joiningServers) {
                                ...
                                String[] var35 = StringUtils.split(joiner, "=").toArray(new String[0]);
                                if (var35.length != 2) {
                                ...
                                Long sid = Long.parseLong(var35[0].substring(var35[0].lastIndexOf('.') + 1));
                                QuorumServer qs = new QuorumServer(sid, var35[1]);
