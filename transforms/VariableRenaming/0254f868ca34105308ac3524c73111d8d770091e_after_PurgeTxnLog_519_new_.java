...
public class PurgeTxnLog {
    ...
    public static void main(String[] args) throws IOException {
        ...
        class MyFileFilter implements FileFilter {
            ...
            public boolean accept(File var12) {
                if (!var12.getName().startsWith(prefix) || exclude.contains(var12))
                    return false;
                return true;
            }
        }
        ...
        for (File var12 : files) {
            System.out.println("Removing file: " + DateFormat.getDateTimeInstance().format(var12.lastModified()) + "\t" + var12.getPath());
            if (!var12.delete()) {
                System.err.println("Failed to remove " + var12.getPath());
            }
        }
    }
}
