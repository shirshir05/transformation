        ...
        try {
            ...
            switch(header.getType()) {
                ...
                case OpCode.delete:
                    ...
                    break;
                case OpCode.setData:
                    SetDataTxn var6 = (SetDataTxn) txn;
                    debug = "Set data transaction for " + var6.getPath() + " to new value=" + Arrays.toString(var6.getData());
                    rc.stat = setData(var6.getPath(), var6.getData(), var6.getVersion(), header.getZxid(), header.getTime());
                    break;
                case OpCode.setACL:
