    ...
    public void parseProperties(Properties zkProp) throws IOException, ConfigException {
        ...
        for (Entry<Object, Object> entry : zkProp.entrySet()) {
            ...
            if (key.equals("dataDir")) {
                ...
                numGroups++;
                String[] parts = value.split(":");
                for (String var22 : parts) {
                    long sid = Long.parseLong(var22);
        ...
        if (servers.size() == 0) {
             ...
             */
            if (electionAlg != 0) {
                for (QuorumServer var22 : servers.values()) {
                    if (var22.electionAddr == null)
                        throw new IllegalArgumentException("Missing election port for server: " + var22.id);
                }
            }
            /*
            ...
            if (serverGroup.size() > 0) {
                 ...
                 */
                for (QuorumServer var22 : servers.values()) {
                    if (!serverWeight.containsKey(var22.id))
                        serverWeight.put(var22.id, (long) 1);
                }
                /*
