...
public class DataTree {
     ...
     */
    public String createNode(String path, byte[] data, List<ACL> acl, long var3, long zxid, long time) throws KeeperException.NoNodeException, KeeperException.NodeExistsException {
        ...
        synchronized (parent) {
            ...
            if (var3 != 0) {
                HashSet<String> list = ephemerals.get(var3);
                if (list == null) {
                    list = new HashSet<String>();
                    ephemerals.put(var3, list);
                }
                synchronized (list) {
                    list.add(path);
                }
