...
class ClientCnxn {
    ...
    public void addAuthInfo(String scheme, byte[] var1) {
        authInfo.add(new AuthData(scheme, var1));
        if (zooKeeper.state == States.CONNECTED) {
            queuePacket(new RequestHeader(-4, OpCode.var1), null, new AuthPacket(0, scheme, var1), null, null, null, null, null);
        }
    }
}
