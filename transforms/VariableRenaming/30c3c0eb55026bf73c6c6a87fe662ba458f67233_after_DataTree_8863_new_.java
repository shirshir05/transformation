...
public class DataTree {
     ...
     */
    public String createNode(String path, byte[] var1, List<ACL> acl, long ephemeralOwner, long zxid, long time) throws KeeperException.NoNodeException, KeeperException.NodeExistsException {
        ...
        synchronized (parent) {
            ...
            DataNode child = new DataNode(parent, var1, longval, stat);
