        ...
        try {
            ...
            switch(request.type) {
                ...
                case OpCode.var21:
                    {
                        lastOp = "SETW";
                        SetWatches var21 = new SetWatches();
                        // XXX We really should NOT need this!!!!
                        request.request.rewind();
                        ZooKeeperServer.byteBuffer2Record(request.request, var21);
                        long relativeZxid = var21.getRelativeZxid();
                        zks.getZKDatabase().var21(relativeZxid, var21.getDataWatches(), var21.getExistWatches(), var21.getChildWatches(), cnxn);
                        break;
                    }
                case OpCode.getACL:
                    {
