...
public class NIOServerCnxn implements Watcher, ServerCnxn {
    ...
    public void close() {
        ...
        try {
            ...
            LOG.warn("ignoring exception during socket close", var5);
        }
        try {
            sock.close();
        } catch (IOException var5) {
            LOG.warn("ignoring exception during socketchannel close", var5);
        }
        sock = null;
        if (sk != null) {
            try {
                ...
                LOG.warn("ignoring exception during selectionkey cancel", var5);
            }
        }
    }
