    ...
    public void toSend(Long sid, ByteBuffer b) {
        ...
        if (self.getId() == sid) {
            ...
            try {
                 ...
                 */
                if (!queueSendMap.containsKey(sid)) {
                    ArrayBlockingQueue<ByteBuffer> var3 = new ArrayBlockingQueue<ByteBuffer>(CAPACITY);
                    queueSendMap.put(sid, var3);
                    var3.put(b);
                } else {
                    ArrayBlockingQueue<ByteBuffer> var3 = queueSendMap.get(sid);
                    if (var3 != null) {
                        if (var3.remainingCapacity() == 0) {
                            var3.take();
                        }
                        var3.put(b);
                    } else {
