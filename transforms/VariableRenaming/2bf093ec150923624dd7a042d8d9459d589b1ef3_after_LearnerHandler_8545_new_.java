            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.REVALIDATE:
                        ...
                        dos.writeLong(id);
                        boolean var29 = leader.zk.touch(id, to);
                        if (var29) {
                            try {
                                // owns the session
                        ...
                        if (LOG.isTraceEnabled()) {
                            ZooTrace.logTraceMessage(LOG, ZooTrace.SESSION_TRACE_MASK, "Session 0x" + Long.toHexString(id) + " is valid: " + var29);
                        }
                        dos.writeBoolean(var29);
