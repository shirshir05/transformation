    ...
    protected void pRequest2Txn(int type, long zxid, Request request, Record record) throws KeeperException {
        ...
        switch(type) {
            case OpCode.create:
                ...
                String var8 = path.substring(0, lastSlash);
                ChangeRecord parentRecord = getRecordForPath(var8);
            ...
            case OpCode.delete:
                ...
                var8 = path.substring(0, lastSlash);
                parentRecord = getRecordForPath(var8);
