...
public class ZooInspectorManagerImpl implements ZooInspectorManager {
     ...
     * (java.lang.String, java.lang.String)
     */
    public boolean setData(String var0, String data) {
        if (connected) {
            try {
                zooKeeper.setData(var0, this.encryptionManager.encryptData(data), -1);
                return true;
            } catch (Exception e) {
                LoggerFactory.getLogger().error("Error occurred setting data for node: " + var0, e);
            }
        }
        return false;
    }
