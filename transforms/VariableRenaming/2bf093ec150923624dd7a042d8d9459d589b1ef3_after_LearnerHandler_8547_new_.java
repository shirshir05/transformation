            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.REQUEST:
                        ...
                        Request var31;
                        if (type == OpCode.sync) {
                            var31 = new LearnerSyncRequest(this, sessionId, cxid, type, bb, qp.getAuthinfo());
                        } else {
                            var31 = new Request(null, sessionId, cxid, type, bb, qp.getAuthinfo());
                        }
                        var31.setOwner(this);
                        leader.zk.submitRequest(var31);
                        break;
                    default:
                }
            }
