                ...
                while (true) {
                    ...
                    if (event instanceof WatcherEvent) {
                        ...
                        if (p.cb == null) {
                            ...
                            GetDataResponse var8 = (GetDataResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, path, p.ctx, var8.getData(), var8.getStat());
                            } else {
                                cb.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetACLResponse) {
                            ACLCallback cb = (ACLCallback) p.cb;
                            GetACLResponse var8 = (GetACLResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, path, p.ctx, var8.getAcl(), var8.getStat());
                            } else {
                                cb.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetChildrenResponse) {
                            ChildrenCallback cb = (ChildrenCallback) p.cb;
                            GetChildrenResponse var8 = (GetChildrenResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, path, p.ctx, var8.getChildren());
                            } else {
                                cb.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof CreateResponse) {
                            StringCallback cb = (StringCallback) p.cb;
                            CreateResponse var8 = (CreateResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, path, p.ctx, var8.getPath());
                            } else {
                                cb.processResult(rc, path, p.ctx, null);
                            }
