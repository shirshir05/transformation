                ...
                case OpCode.exists:
                    {
                        ...
                        ExistsRequest var13 = new ExistsRequest();
                        ZooKeeperServer.byteBuffer2Record(request.request, var13);
                        String path = var13.getPath();
                        if (path.indexOf('\0') != -1) {
                            throw new KeeperException.BadArgumentsException();
                        }
                        Stat stat = zks.getZKDatabase().statNode(path, var13.getWatch() ? cnxn : null);
