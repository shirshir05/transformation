...
public class FastLeaderElection implements Election {
    ...
    public Vote lookForLeader() throws InterruptedException {
        ...
        try {
             ...
             */
            Map<Long, Vote> var1 = new HashMap<Long, Vote>();
            /*
                ...
                if (n == null) {
                    ...
                    switch(n.state) {
                        case LOOKING:
                            ...
                            voteSet = getVoteTracker(var1, new Vote(proposedLeader, proposedZxid, logicalclock.get(), proposedEpoch));
                         ...
                         */
                            if (n.electionEpoch == logicalclock.get()) {
                                var1.put(n.sid, new Vote(n.leader, n.zxid, n.electionEpoch, n.peerEpoch, n.state));
                                voteSet = getVoteTracker(var1, new Vote(n.version, n.leader, n.zxid, n.electionEpoch, n.peerEpoch, n.state));
                                if (voteSet.hasAllQuorums() && checkLeader(var1, n.leader, n.electionEpoch)) {
