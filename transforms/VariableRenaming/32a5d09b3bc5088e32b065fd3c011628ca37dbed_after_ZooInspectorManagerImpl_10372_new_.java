...
public class ZooInspectorManagerImpl implements ZooInspectorManager {
    ...
    private void loadDefaultConnectionFile() throws IOException {
        if (defaultConnectionFile.exists()) {
            ...
            defaultEncryptionManager = var0.getProperty(DATA_ENCRYPTION_MANAGER) == null ? "org.apache.zookeeper.inspector.encryption.BasicDataEncryptionManager" : var0.getProperty(DATA_ENCRYPTION_MANAGER);
            defaultTimeout = var0.getProperty(SESSION_TIMEOUT) == null ? "5000" : var0.getProperty(SESSION_TIMEOUT);
            defaultHosts = var0.getProperty(CONNECT_STRING) == null ? "localhost:2181" : var0.getProperty(CONNECT_STRING);
        } else {
