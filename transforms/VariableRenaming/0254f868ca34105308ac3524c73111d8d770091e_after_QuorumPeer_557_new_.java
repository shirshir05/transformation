...
public class QuorumPeer extends Thread implements QuorumStats.Provider {
    ...
    protected Leader makeLeader(FileTxnSnapLog var0) throws IOException {
        return new Leader(this, new LeaderZooKeeperServer(var0, this, new ZooKeeperServer.BasicDataTreeBuilder()));
    }
