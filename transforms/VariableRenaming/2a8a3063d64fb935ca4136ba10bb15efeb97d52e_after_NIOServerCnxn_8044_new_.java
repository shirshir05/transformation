...
public class NIOServerCnxn implements Watcher, ServerCnxn {
    ...
    private class MonitorCommand extends CommandThread {
        ...
        public void commandRun() {
            ...
            ZKDatabase var0 = zk.getZKDatabase();
            ...
            print("znode_count", var0.getNodeCount());
            print("watch_count", var0.getDataTree().getWatchCount());
            print("ephemerals_count", var0.getDataTree().getEphemeralsCount());
            print("approximate_data_size", var0.getDataTree().approximateDataSize());
