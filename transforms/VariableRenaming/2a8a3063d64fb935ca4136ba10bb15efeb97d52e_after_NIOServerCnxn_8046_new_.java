...
public class NIOServerCnxn implements Watcher, ServerCnxn {
    ...
    private class MonitorCommand extends CommandThread {
        ...
        public void commandRun() {
            ...
            OperatingSystemMXBean var2 = ManagementFactory.getOperatingSystemMXBean();
            if (var2 != null && var2 instanceof UnixOperatingSystemMXBean) {
                UnixOperatingSystemMXBean unixos = (UnixOperatingSystemMXBean) var2;
