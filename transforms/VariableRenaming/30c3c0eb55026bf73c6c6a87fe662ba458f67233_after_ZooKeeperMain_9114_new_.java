...
public class ZooKeeperMain {
    ...
    private static void printStat(Stat var0) {
        System.err.println("cZxid = " + var0.getCzxid());
        System.err.println("ctime = " + new Date(var0.getCtime()).toString());
        System.err.println("mZxid = " + var0.getMzxid());
        System.err.println("mtime = " + new Date(var0.getMtime()).toString());
        System.err.println("pZxid = " + var0.getPzxid());
        System.err.println("cversion = " + var0.getCversion());
        System.err.println("dataVersion = " + var0.getVersion());
        System.err.println("aclVersion = " + var0.getAversion());
        System.err.println("ephemeralOwner = " + var0.getEphemeralOwner());
        System.err.println("dataLength = " + var0.getDataLength());
        System.err.println("numChildren = " + var0.getNumChildren());
    }
