    ...
    public void configure(String params) {
        if (clientAddr == null) {
            ...
            for (int i = 0; i < parts.length; i++) {
                ...
                String var19 = (parts[i].split(";"))[1];
                peers.put(Long.valueOf(i), new QuorumServer(i, new InetSocketAddress(subparts[0], Integer.parseInt(subparts[1])), new InetSocketAddress(subparts[0], Integer.parseInt(subparts[2])), new InetSocketAddress(subparts[0], Integer.parseInt(var19))));
            }
            try {
                if (LOG.isDebugEnabled()) {
