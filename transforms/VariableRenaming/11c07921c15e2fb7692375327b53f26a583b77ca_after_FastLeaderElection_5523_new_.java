...
public class FastLeaderElection implements Election {
    ...
    synchronized void updateProposal(long leader, long var1, long epoch) {
        LOG.debug("Updating proposal: {} (newleader), 0x{} (newzxid), {} (oldleader), 0x{} (oldzxid)", leader, Long.toHexString(var1), proposedLeader, Long.toHexString(proposedZxid));
