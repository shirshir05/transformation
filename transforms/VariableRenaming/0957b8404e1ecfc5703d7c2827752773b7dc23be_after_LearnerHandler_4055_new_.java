    ...
    public void run() {
        try {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        LOG.warn("Unexpected interruption", var26);
                    }
                }
            }.start();
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.REVALIDATE:
                        ...
                        if (valid) {
                            ...
                            } catch (SessionExpiredException var26) {
                                LOG.error("Somehow session " + Long.toHexString(id) + " expired right after being renewed! (impossible)", var26);
                            }
                        }
                        if (LOG.isTraceEnabled()) {
            ...
            if (sock != null && !sock.isClosed()) {
                LOG.error("Unexpected exception causing shutdown while sock " + "still open", var26);
            }
        } catch (InterruptedException var26) {
            LOG.error("Unexpected exception causing shutdown", var26);
        } finally {
            ...
            try {
                ...
                LOG.warn("Ignoring unexpected exception", var26);
            }
            shutdown();
        }
    }
