    ...
    private boolean fixupACL(List<Id> authInfo, List<ACL> acl) {
        ...
        while (it.hasNext()) {
            ...
            if (id.getScheme().equals("world") && id.getId().equals("anyone")) {
                ...
                for (Id cid : authInfo) {
                    AuthenticationProvider var8 = ProviderRegistry.getProvider(cid.getScheme());
                    if (var8 == null) {
                        LOG.error("Missing AuthenticationProvider for " + cid.getScheme());
                    } else if (var8.isAuthenticated()) {
                        authIdValid = true;
                ...
                AuthenticationProvider var8 = ProviderRegistry.getProvider(id.getScheme());
                if (var8 == null) {
                    return false;
                }
                if (!var8.isValid(id.getId())) {
                    return false;
                }
            }
        }
