...
public class PrepRequestProcessor extends ZooKeeperCriticalThread implements RequestProcessor {
    ...
    private void pRequest2TxnCreate(int type, Request request, Record record, boolean deserialize) throws IOException, KeeperException {
        ...
        parentRecord.precalculatedDigest = precalculateDigest(DigestOpCode.UPDATE, parentPath, parentRecord.data, parentRecord.stat);
        addChangeRecord(parentRecord);
        ChangeRecord var22 = new ChangeRecord(request.getHdr().getZxid(), path, s, 0, listACL);
        var22.data = data;
        var22.precalculatedDigest = precalculateDigest(DigestOpCode.ADD, path, var22.data, s);
        setTxnDigest(request, var22.precalculatedDigest);
        addChangeRecord(var22);
    }
