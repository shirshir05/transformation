...
public class QuorumPeerConfig {
    ...
    public void parse(String path) throws ConfigException {
        ...
        try {
            File var1 = (new VerifyingFileFactory.Builder(LOG).warnForRelativePath().failForNonExistingPath().build()).create(path);
            Properties cfg = new Properties();
            FileInputStream in = new FileInputStream(var1);
            try {
                cfg.load(in);
            } finally {
                in.close();
