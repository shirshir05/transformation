...
public class NIOServerCnxn implements Watcher, ServerCnxn {
    ...
    public void close() {
        ...
        try {
            ...
            LOG.warn("ignoring exception during socket close", var3);
        }
        try {
            sock.close();
        } catch (IOException var3) {
            LOG.warn("ignoring exception during socketchannel close", var3);
        }
        sock = null;
        if (sk != null) {
            try {
                ...
                LOG.warn("ignoring exception during selectionkey cancel", var3);
            }
        }
    }
