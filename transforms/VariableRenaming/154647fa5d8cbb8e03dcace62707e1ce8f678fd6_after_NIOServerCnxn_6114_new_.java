...
public class NIOServerCnxn implements Watcher, ServerCnxn {
    ...
    public void close() {
        ...
        try {
            ...
            LOG.warn("Failed to unregister with JMX", var5);
        }
        ...
        try {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("ignoring exception during output shutdown", var5);
            }
        }
        try {
            ...
            // This is a relatively common exception that we can't avoid
            if (LOG.isDebugEnabled()) {
                LOG.debug("ignoring exception during input shutdown", var5);
            }
        }
        try {
            sock.socket().close();
        ...
        try {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("ignoring exception during socketchannel close", var5);
            }
        }
        sock = null;
        if (sk != null) {
            try {
                ...
                if (LOG.isDebugEnabled()) {
                    LOG.debug("ignoring exception during selectionkey cancel", var5);
                }
            }
        }
    }
