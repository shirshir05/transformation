...
public class QuorumCnxManager {
    ...
    synchronized void connectOne(long sid) {
        ...
        synchronized (self) {
            ...
            if (self.getLastSeenQuorumVerifier() != null && self.getLastSeenQuorumVerifier().getAllMembers().containsKey(sid) && (!var1 || (self.getLastSeenQuorumVerifier().getAllMembers().get(sid).electionAddr != self.getView().get(sid).electionAddr))) {
                var1 = true;
