        ...
        try {
            ...
            switch(header.getType()) {
                ...
                case OpCode.delete:
                    ...
                    break;
                case OpCode.setData:
                    SetDataTxn var5 = (SetDataTxn) txn;
                    debug = "Set data for  transaction for " + var5.getPath();
                    rc.stat = setData(var5.getPath(), var5.getData(), var5.getVersion(), header.getZxid(), header.getTime());
                    break;
                case OpCode.setACL:
