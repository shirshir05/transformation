    ...
    protected void pRequest2Txn(int type, long zxid, Request request, Record record, boolean deserialize) throws KeeperException, IOException, RequestProcessorException {
        ...
        switch(type) {
            ...
            case OpCode.setData:
                ...
                checkACL(zks, var8.acl, ZooDefs.Perms.WRITE, request.authInfo);
            ...
            case OpCode.setACL:
                ...
                var8 = getRecordForPath(path);
                checkACL(zks, var8.acl, ZooDefs.Perms.ADMIN, request.authInfo);
            ...
            case OpCode.check:
                ...
                validatePath(path, request.sessionId);
                var8 = getRecordForPath(path);
                checkACL(zks, var8.acl, ZooDefs.Perms.READ, request.authInfo);
