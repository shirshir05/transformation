        ...
        try {
            ...
            if (learnerType == LearnerType.PARTICIPANT) {
                ...
                if (this.getVersion() < 0x10000) {
                    ...
                    var6 = new StateSummary(epoch, zxid);
                    // fake the message
                    leader.waitForEpochAck(this.getSid(), var6);
                } else {
                    byte[] ver = new byte[4];
                    ...
                    var6 = new StateSummary(bbepoch.getInt(), ackEpochPacket.getZxid());
                    leader.waitForEpochAck(this.getSid(), var6);
                }
                peerLastZxid = var6.getLastZxid();
            } else {
