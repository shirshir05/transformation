...
public class PurgeTxnLog {
    ...
    public static void main(String[] args) throws IOException {
        ...
        class MyFileFilter implements FileFilter {
            ...
            public boolean accept(File var10) {
                if (!var10.getName().startsWith(prefix) || exclude.contains(var10))
                    return false;
                return true;
            }
        }
        ...
        for (File var10 : files) {
            System.out.println("Removing file: " + DateFormat.getDateTimeInstance().format(var10.lastModified()) + "\t" + var10.getPath());
            if (!var10.delete()) {
                System.err.println("Failed to remove " + var10.getPath());
            }
        }
    }
}
