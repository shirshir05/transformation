            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.PING:
                        ...
                        DataInputStream var22 = new DataInputStream(bis);
                        while (var22.available() > 0) {
                            long sess = var22.readLong();
                            int to = var22.readInt();
                            leader.zk.touch(sess, to);
                        }
                        break;
                    case Leader.REVALIDATE:
                        bis = new ByteArrayInputStream(qp.getData());
                        var22 = new DataInputStream(bis);
                        long id = var22.readLong();
                        int to = var22.readInt();
