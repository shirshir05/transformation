                    ...
                    try {
                        if (leavingServers != null) {
                            for (String leaving : leavingServers) {
                                long var36 = Long.parseLong(leaving);
                                nextServers.remove(var36);
                            }
                        }
                        if (joiningServers != null) {
                            for (String joiner : joiningServers) {
                                ...
                                Long var36 = Long.parseLong(parts[0].substring(parts[0].lastIndexOf('.') + 1));
                                QuorumServer qs = new QuorumServer(var36, parts[1]);
