                ...
                while (true) {
                    ...
                    if (event instanceof WatcherEvent) {
                        ...
                        if (p.var13 == null) {
                            ...
                            StatCallback var13 = (StatCallback) p.var13;
                            if (rc == 0) {
                                if (p.response instanceof ExistsResponse) {
                                    var13.processResult(rc, path, p.ctx, ((ExistsResponse) p.response).getStat());
                                } else if (p.response instanceof SetDataResponse) {
                                    var13.processResult(rc, path, p.ctx, ((SetDataResponse) p.response).getStat());
                                } else if (p.response instanceof SetACLResponse) {
                                    var13.processResult(rc, path, p.ctx, ((SetACLResponse) p.response).getStat());
                                }
                            } else {
                                var13.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof GetDataResponse) {
                            DataCallback var13 = (DataCallback) p.var13;
                            GetDataResponse rsp = (GetDataResponse) p.response;
                            if (rc == 0) {
                                var13.processResult(rc, path, p.ctx, rsp.getData(), rsp.getStat());
                            } else {
                                var13.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetACLResponse) {
                            ACLCallback var13 = (ACLCallback) p.var13;
                            GetACLResponse rsp = (GetACLResponse) p.response;
                            if (rc == 0) {
                                var13.processResult(rc, path, p.ctx, rsp.getAcl(), rsp.getStat());
                            } else {
                                var13.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetChildrenResponse) {
                            ChildrenCallback var13 = (ChildrenCallback) p.var13;
                            GetChildrenResponse rsp = (GetChildrenResponse) p.response;
                            if (rc == 0) {
                                var13.processResult(rc, path, p.ctx, rsp.getChildren());
                            } else {
                                var13.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof CreateResponse) {
                            StringCallback var13 = (StringCallback) p.var13;
                            CreateResponse rsp = (CreateResponse) p.response;
                            if (rc == 0) {
                                var13.processResult(rc, path, p.ctx, rsp.getPath());
                            } else {
                                var13.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.var13 instanceof VoidCallback) {
                            VoidCallback var13 = (VoidCallback) p.var13;
                            var13.processResult(rc, path, p.ctx);
                        }
                    }
                }
