...
public class DataTree {
    ...
    static public void copyStat(Stat var0, Stat to) {
        to.setAversion(var0.getAversion());
        to.setCtime(var0.getCtime());
        to.setCversion(var0.getCversion());
        to.setCzxid(var0.getCzxid());
        to.setMtime(var0.getMtime());
        to.setMzxid(var0.getMzxid());
        to.setPzxid(var0.getPzxid());
        to.setVersion(var0.getVersion());
        to.setEphemeralOwner(var0.getEphemeralOwner());
        to.setDataLength(var0.getDataLength());
        to.setNumChildren(var0.getNumChildren());
    }
