...
public class FinalRequestProcessor implements RequestProcessor {
    ...
    public void processRequest(Request request) {
        ...
        try {
            ...
            switch(request.type) {
                ...
                case OpCode.createSession:
                    ...
                    return;
                case OpCode.create:
                    var5 = new CreateResponse(rc.path);
                    err = rc.err;
                    break;
                case OpCode.delete:
                    err = rc.err;
                    break;
                case OpCode.setData:
                    var5 = new SetDataResponse(rc.stat);
                    err = rc.err;
                    break;
                case OpCode.setACL:
                    var5 = new SetACLResponse(rc.stat);
                    err = rc.err;
                    break;
                ...
                case OpCode.getData:
                    ...
                    var5 = new GetDataResponse(b, stat);
                    break;
                case OpCode.getACL:
                    ...
                    var5 = new GetACLResponse(acl, stat);
                    break;
                case OpCode.getChildren:
                    ...
                    var5 = new GetChildrenResponse(children);
                    break;
            }
        ...
        try {
            request.cnxn.sendResponse(hdr, var5, "response");
        } catch (IOException e) {
            ZooLog.logException(e);
        }
    }
