                        ...
                        if (p.cb == null) {
                            ...
                            if (var2 == 0) {
                                if (p.response instanceof ExistsResponse) {
                                    cb.processResult(var2, path, p.ctx, ((ExistsResponse) p.response).getStat());
                                } else if (p.response instanceof SetDataResponse) {
                                    cb.processResult(var2, path, p.ctx, ((SetDataResponse) p.response).getStat());
                                } else if (p.response instanceof SetACLResponse) {
                                    cb.processResult(var2, path, p.ctx, ((SetACLResponse) p.response).getStat());
                                }
                            } else {
                                cb.processResult(var2, path, p.ctx, null);
                            }
                        } else if (p.response instanceof GetDataResponse) {
                            DataCallback cb = (DataCallback) p.cb;
                            GetDataResponse rsp = (GetDataResponse) p.response;
                            if (var2 == 0) {
                                cb.processResult(var2, path, p.ctx, rsp.getData(), rsp.getStat());
                            } else {
                                cb.processResult(var2, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetACLResponse) {
                            ACLCallback cb = (ACLCallback) p.cb;
                            GetACLResponse rsp = (GetACLResponse) p.response;
                            if (var2 == 0) {
                                cb.processResult(var2, path, p.ctx, rsp.getAcl(), rsp.getStat());
                            } else {
                                cb.processResult(var2, path, p.ctx, null, null);
                            }
                            ...
                            if (var2 == 0) {
                                cb.processResult(var2, path, p.ctx, rsp.getChildren());
                            } else {
                                cb.processResult(var2, path, p.ctx, null);
                            }
                            ...
                            if (var2 == 0) {
                                cb.processResult(var2, path, p.ctx, rsp.getPath());
                            } else {
                                cb.processResult(var2, path, p.ctx, null);
                            }
                        } else if (p.cb instanceof VoidCallback) {
                            VoidCallback cb = (VoidCallback) p.cb;
                            cb.processResult(var2, path, p.ctx);
                        }
                    }
                }
