        ...
        try {
            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.PING:
                        // Process the touches
                        ByteArrayInputStream var17 = new ByteArrayInputStream(qp.getData());
                        DataInputStream dis = new DataInputStream(var17);
                        ...
                        break;
                    case Leader.REVALIDATE:
                        var17 = new ByteArrayInputStream(qp.getData());
                        dis = new DataInputStream(var17);
                        long id = dis.readLong();
                        int to = dis.readInt();
