...
public class FastLeaderElection implements Election {
    ...
    public Vote lookForLeader() throws InterruptedException {
        HashMap<Long, Vote> var0 = new HashMap<Long, Vote>();
            ...
            if (n == null) {
                ...
                switch(n.state) {
                    case LOOKING:
                        ...
                        var0.put(n.sid, new Vote(n.leader, n.zxid, n.epoch));
                        // If have received from all nodes, then terminate
                        if (self.quorumPeers.size() == var0.size()) {
                            self.setPeerState((proposedLeader == self.getId()) ? ServerState.LEADING : ServerState.FOLLOWING);
                            leaveInstance();
                            return new Vote(proposedLeader, proposedZxid);
                        } else if (termPredicate(var0, new Vote(proposedLeader, proposedZxid, logicalclock))) {
