        ...
        try {
            ...
            switch(request.type) {
                ...
                case OpCode.setData:
                    {
                        lastOp = "SETD";
                        rsp = new SetDataResponse(rc.var31);
                        err = Code.get(rc.err);
                        break;
                    }
                case OpCode.setACL:
                    {
                        lastOp = "SETA";
                        rsp = new SetACLResponse(rc.var31);
                        err = Code.get(rc.err);
                        break;
                    }
                ...
                case OpCode.exists:
                    {
                        ...
                        Stat var31 = zks.getZKDatabase().statNode(path, existsRequest.getWatch() ? cnxn : null);
                        rsp = new ExistsResponse(var31);
                        break;
                    }
                case OpCode.getData:
                    {
                        ...
                        Stat var31 = new Stat();
                        byte[] b = zks.getZKDatabase().getData(getDataRequest.getPath(), var31, getDataRequest.getWatch() ? cnxn : null);
                        rsp = new GetDataResponse(b, var31);
                        break;
                    }
                ...
                case OpCode.getACL:
                    {
                        ...
                        Stat var31 = new Stat();
                        List<ACL> acl = zks.getZKDatabase().getACL(getACLRequest.getPath(), var31);
                        rsp = new GetACLResponse(acl, var31);
                        break;
                    }
                ...
                case OpCode.getChildren2:
                    {
                        ...
                        PrepRequestProcessor.checkACL(zks, zks.getZKDatabase().convertLong(aclG), ZooDefs.Perms.READ, request.authInfo);
                        List<String> children = zks.getZKDatabase().getChildren(getChildren2Request.getPath(), var31, getChildren2Request.getWatch() ? cnxn : null);
                        rsp = new GetChildren2Response(children, var31);
                        break;
                    }
            }
