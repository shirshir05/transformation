    ...
    public void run() {
        try {
            ...
            try {
                ...
                final long var21 = leader.zk.getZKDatabase().getminCommittedLog();
                LOG.info("Synchronizing with Follower sid: " + this.sid + " maxCommittedLog =" + Long.toHexString(maxCommittedLog) + " minCommittedLog = " + Long.toHexString(var21) + " peerLastZxid = " + Long.toHexString(peerLastZxid));
                LinkedList<Proposal> proposals = leader.zk.getZKDatabase().getCommittedLog();
                if (proposals.size() != 0) {
                    if ((maxCommittedLog >= peerLastZxid) && (var21 <= peerLastZxid)) {
                        // proposal Id.
                        long prevProposalZxid = var21;
