    ...
    void lead() throws IOException, InterruptedException {
        ...
        try {
            ...
            while (true) {
                ...
                HashSet<Long> var6 = new HashSet<Long>();
                ...
                if (!tickSkip && !self.getQuorumVerifier().containsQuorum(var6)) {
                    // TODO: message is wrong unless majority quorums used
                    shutdown("Only " + var6.size() + " followers, need " + (self.getVotingView().size() / 2));
