...
public class FastLeaderElection implements Election {
     ...
     * current vote.
     */
    protected boolean totalOrderPredicate(long newId, long newZxid, long newEpoch, long curId, long var4, long curEpoch) {
        LOG.debug("id: {}, proposed id: {}, zxid: 0x{}, proposed zxid: 0x{}", newId, curId, Long.toHexString(newZxid), Long.toHexString(var4));
        if (self.getQuorumVerifier().getWeight(newId) == 0) {
            return false;
        }
        return ((newEpoch > curEpoch) || ((newEpoch == curEpoch) && ((newZxid > var4) || ((newZxid == var4) && (newId > curId)))));
    }
