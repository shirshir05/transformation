            ...
            try {
                ...
                if (s != null) {
                    ...
                    for (ACL acl : acls) {
                        ...
                        int var7 = acl.getPerms();
                        boolean addedPerm = false;
                        if ((var7 & Perms.READ) == Perms.READ) {
                            sb.append("Read");
                            addedPerm = true;
                        }
                        if (addedPerm) {
                        ...
                        if ((var7 & Perms.WRITE) == Perms.WRITE) {
                            sb.append("Write");
                            addedPerm = true;
                        }
                        if (addedPerm) {
                        ...
                        if ((var7 & Perms.CREATE) == Perms.CREATE) {
                            sb.append("Create");
                            addedPerm = true;
                        }
                        if (addedPerm) {
                        ...
                        if ((var7 & Perms.DELETE) == Perms.DELETE) {
                            sb.append("Delete");
                            addedPerm = true;
                        }
                        if (addedPerm) {
                        ...
                        if ((var7 & Perms.ADMIN) == Perms.ADMIN) {
                            sb.append("Admin");
                            addedPerm = true;
                        }
