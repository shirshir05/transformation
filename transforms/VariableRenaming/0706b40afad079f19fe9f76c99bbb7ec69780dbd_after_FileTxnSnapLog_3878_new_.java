...
public class FileTxnSnapLog {
     ...
     * @throws IOException
     */
    public void save(DataTree var0, ConcurrentHashMap<Long, Integer> sessionsWithTimeouts, boolean syncSnap) throws IOException {
        long lastZxid = var0.lastProcessedZxid;
        File snapshotFile = new File(snapDir, Util.makeSnapshotName(lastZxid));
        LOG.info("Snapshotting: 0x{} to {}", Long.toHexString(lastZxid), snapshotFile);
        snapLog.serialize(var0, sessionsWithTimeouts, snapshotFile, syncSnap);
    }
