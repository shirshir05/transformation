...
public class ZooKeeper {
    ...
    public Stat exists(String path, Watcher watcher) throws KeeperException, InterruptedException {
        ...
        if (watcher != null) {
            wcb = new ExistsWatchRegistration(watchManager.dataWatches, watcher, path);
        }
    ...
    public byte[] getData(String path, Watcher watcher, Stat stat) throws KeeperException, InterruptedException {
        ...
        WatchRegistration wcb = null;
        if (watcher != null) {
            wcb = new WatchRegistration(watchManager.dataWatches, watcher, path);
        }
        ReplyHeader r = cnxn.submitRequest(h, request, response, wcb);
        if (r.getErr() != 0) {
            throw KeeperException.create(r.getErr());
    ...
    public List<String> getChildren(String path, Watcher watcher) throws KeeperException, InterruptedException {
        ...
        WatchRegistration wcb = null;
        if (watcher != null) {
            wcb = new WatchRegistration(watchManager.childWatches, watcher, path);
        }
        ReplyHeader r = cnxn.submitRequest(h, request, response, wcb);
        if (r.getErr() != 0) {
            throw KeeperException.create(r.getErr());
