...
public class DataTree {
    ...
    public void setWatches(long relativeZxid, List<String> dataWatches, List<String> existWatches, List<String> var3, Watcher watcher) {
        ...
        for (String path : var3) {
            ...
            if (e != null) {
                ...
                this.var3.addWatch(path, watcher);
            }
        }
    }
}
