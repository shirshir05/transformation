            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.PING:
                        ...
                        DataInputStream var18 = new DataInputStream(bis);
                        while (var18.available() > 0) {
                            long sess = var18.readLong();
                            int to = var18.readInt();
                            leader.zk.touch(sess, to);
                        }
                        break;
                    case Leader.REVALIDATE:
                        bis = new ByteArrayInputStream(qp.getData());
                        var18 = new DataInputStream(bis);
                        long id = var18.readLong();
                        int to = var18.readInt();
