...
public class ZooInspectorManagerImpl implements ZooInspectorManager {
     ...
     */
    public List<String> getChildren(String var0) {
        if (connected) {
            try {
                return zooKeeper.getChildren(var0, false);
            } catch (Exception e) {
                LoggerFactory.getLogger().error("Error occurred retrieving children of node: " + var0, e);
            }
        }
        return null;
    }
