...
public class DataTree {
    ...
    public void setWatches(long relativeZxid, List<String> var1, List<String> existWatches, List<String> childWatches, Watcher watcher) {
        for (String path : var1) {
            ...
            if (e != null) {
                ...
                this.var1.addWatch(path, watcher);
            }
        }
