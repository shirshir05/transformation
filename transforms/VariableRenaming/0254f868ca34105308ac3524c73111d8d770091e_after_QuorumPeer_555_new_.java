...
public class QuorumPeer extends Thread implements QuorumStats.Provider {
    ...
    public QuorumPeer(ArrayList<QuorumServer> quorumPeers, File dataDir, File dataLogDir, int electionAlg, int electionPort, long myid, int tickTime, int initLimit, int syncLimit, NIOServerCnxn.Factory cnxnFactory) throws IOException {
        super("QuorumPeer");
    ...
    public QuorumPeer(ArrayList<QuorumServer> quorumPeers, FileTxnSnapLog logFactory, int electionAlg, int electionPort, long myid, int tickTime, int initLimit, int syncLimit, NIOServerCnxn.Factory cnxnFactory) throws IOException {
        super("QuorumPeer");
        this.cnxnFactory = cnxnFactory;
        this.quorumPeers = quorumPeers;
        this.electionPort = electionPort;
     ...
     */
    public QuorumPeer(ArrayList<QuorumServer> quorumPeers, File snapDir, File logDir, int clientPort, int electionAlg, int electionPort, long myid, int tickTime, int initLimit, int syncLimit) throws IOException {
        this(quorumPeers, new FileTxnSnapLog(snapDir, logDir), electionAlg, electionPort, myid, tickTime, initLimit, syncLimit, new NIOServerCnxn.Factory(clientPort));
    }
    ...
    protected Follower makeFollower(FileTxnSnapLog var0) throws IOException {
        return new Follower(this, new FollowerZooKeeperServer(var0, this, new ZooKeeperServer.BasicDataTreeBuilder()));
    }
    ...
    private Election createElectionAlgorithm(int electionAlgorithm) {
        ...
        switch(electionAlgorithm) {
            ...
            case 2:
                ...
                break;
            case 3:
                le = new FastLeaderElection(this, new QuorumCnxManager(this.electionPort));
            default:
                assert false;
        }
        return le;
