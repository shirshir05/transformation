            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.PING:
                        ...
                        DataInputStream var35 = new DataInputStream(bis);
                        while (var35.available() > 0) {
                            long sess = var35.readLong();
                            int to = var35.readInt();
                            leader.zk.touch(sess, to);
                        }
                        break;
                    case Leader.REVALIDATE:
                        bis = new ByteArrayInputStream(qp.getData());
                        var35 = new DataInputStream(bis);
                        long id = var35.readLong();
                        int to = var35.readInt();
