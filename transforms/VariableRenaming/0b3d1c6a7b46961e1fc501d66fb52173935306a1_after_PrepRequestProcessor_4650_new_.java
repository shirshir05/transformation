    ...
    protected void pRequest2Txn(int type, long zxid, Request var2, Record record) throws KeeperException {
        ...
        switch(type) {
            case OpCode.create:
                ...
                if (!fixupACL(var2.authInfo, createRequest.getAcl())) {
                ...
                var2.txn = new CreateTxn(path, createRequest.getData(), createRequest.getAcl(), createMode.isEphemeral(), newCversion);
                ...
                addChangeRecord(new ChangeRecord(var2.hdr.getZxid(), path, s, 0, createRequest.getAcl()));
                break;
            case OpCode.delete:
                zks.sessionTracker.checkSession(var2.sessionId, var2.getOwner());
            ...
            case OpCode.setACL:
                ...
                if (!fixupACL(var2.authInfo, setAclRequest.getAcl())) {
                    throw new KeeperException.InvalidACLException(path);
                }
                nodeRecord = getRecordForPath(path);
                ...
                version = currentVersion + 1;
                var2.txn = new SetACLTxn(path, setAclRequest.getAcl(), version);
                nodeRecord = nodeRecord.duplicate(var2.hdr.getZxid());
