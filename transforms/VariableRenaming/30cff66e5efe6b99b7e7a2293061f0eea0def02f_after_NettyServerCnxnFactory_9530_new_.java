...
public class NettyServerCnxnFactory extends ServerCnxnFactory {
    ...
    class CnxnChannelHandler extends SimpleChannelHandler {
        ...
        private void processMessage(MessageEvent var0, NettyServerCnxn cnxn) {
            if (LOG.isDebugEnabled()) {
                LOG.debug(Long.toHexString(cnxn.sessionId) + " queuedBuffer: " + cnxn.queuedBuffer);
            }
            if (var0 instanceof NettyServerCnxn.ResumeMessageEvent) {
                ...
                ChannelBuffer buf = (ChannelBuffer) var0.getMessage();
                if (LOG.isTraceEnabled()) {
