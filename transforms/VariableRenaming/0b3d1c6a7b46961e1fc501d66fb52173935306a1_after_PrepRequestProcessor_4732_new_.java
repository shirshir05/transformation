...
public class PrepRequestProcessor extends Thread implements RequestProcessor {
    ...
    protected void pRequest(Request request) {
        ...
        try {
            switch(request.type) {
                ...
                case OpCode.multi:
                     ...
                     */
                        ...
                        ByteBuffer var17 = ByteBuffer.wrap(baos.toByteArray());
                        txns.add(new Txn(request.hdr.getType(), var17.array()));
                        index++;
                    }
            ...
            ByteBuffer var17 = request.request;
            if (var17 != null) {
                var17.rewind();
                while (var17.hasRemaining()) {
                    sb.append(Integer.toHexString(var17.get() & 0xff));
                }
            } else {
