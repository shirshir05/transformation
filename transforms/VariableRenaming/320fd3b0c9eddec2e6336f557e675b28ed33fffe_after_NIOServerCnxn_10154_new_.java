...
public class NIOServerCnxn implements Watcher, ServerCnxn {
    ...
    public void close() {
        ...
        try {
            ...
            LOG.warn("ignoring exception during socket close", var2);
        }
        try {
            sock.close();
        } catch (IOException var2) {
            LOG.warn("ignoring exception during socketchannel close", var2);
        }
        sock = null;
        if (sk != null) {
            try {
                ...
                LOG.warn("ignoring exception during selectionkey cancel", var2);
            }
        }
    }
