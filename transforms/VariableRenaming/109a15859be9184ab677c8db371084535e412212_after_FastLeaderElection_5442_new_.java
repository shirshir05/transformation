        ...
        while (self.getPeerState() == ServerState.LOOKING) {
            ...
            if (n == null) {
                ...
                switch(n.state) {
                    ...
                    case FOLLOWING:
                        LOG.info("Notification: " + n.leader + ", " + n.zxid + ", " + n.epoch + ", " + self.getId() + ", " + self.getPeerState() + ", " + n.state + ", " + n.sid);
                        var1.put(n.sid, new Vote(n.leader, n.zxid, n.epoch, n.state));
                        if (termPredicate(var1, new Vote(n.leader, n.zxid, n.epoch, n.state)) && checkLeader(var1, n.leader, n.epoch)) {
                            synchronized (this) {
                                logicalclock = n.epoch;
