            ...
            if (var2 == null) {
                ...
                switch(var2.state) {
                    case LOOKING:
                        ...
                        recvset.put(var2.sid, new Vote(var2.leader, var2.zxid));
                    ...
                    case FOLLOWING:
                        LOG.info("Notification: " + var2.leader + ", " + var2.zxid + ", " + var2.epoch + ", " + self.getId() + ", " + self.getPeerState() + ", " + var2.state + ", " + var2.sid);
                        if (var2.epoch >= logicalclock)
                            outofelection.put(var2.sid, new Vote(var2.leader, var2.zxid));
                        if (termPredicate(outofelection, var2.leader, var2.zxid)) {
