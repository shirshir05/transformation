                        ...
                        if (p.cb == null) {
                            ...
                            if (rc == 0) {
                                if (p.response instanceof ExistsResponse) {
                                    cb.processResult(rc, var3, p.ctx, ((ExistsResponse) p.response).getStat());
                                } else if (p.response instanceof SetDataResponse) {
                                    cb.processResult(rc, var3, p.ctx, ((SetDataResponse) p.response).getStat());
                                } else if (p.response instanceof SetACLResponse) {
                                    cb.processResult(rc, var3, p.ctx, ((SetACLResponse) p.response).getStat());
                                }
                            } else {
                                cb.processResult(rc, var3, p.ctx, null);
                            }
                        } else if (p.response instanceof GetDataResponse) {
                            DataCallback cb = (DataCallback) p.cb;
                            GetDataResponse rsp = (GetDataResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, var3, p.ctx, rsp.getData(), rsp.getStat());
                            } else {
                                cb.processResult(rc, var3, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetACLResponse) {
                            ACLCallback cb = (ACLCallback) p.cb;
                            GetACLResponse rsp = (GetACLResponse) p.response;
                            if (rc == 0) {
                                cb.processResult(rc, var3, p.ctx, rsp.getAcl(), rsp.getStat());
                            } else {
                                cb.processResult(rc, var3, p.ctx, null, null);
                            }
                            ...
                            if (rc == 0) {
                                cb.processResult(rc, var3, p.ctx, rsp.getChildren());
                            } else {
                                cb.processResult(rc, var3, p.ctx, null);
                            }
                            ...
                            if (rc == 0) {
                                cb.processResult(rc, var3, p.ctx, rsp.getPath());
                            } else {
                                cb.processResult(rc, var3, p.ctx, null);
                            }
                        } else if (p.cb instanceof VoidCallback) {
                            VoidCallback cb = (VoidCallback) p.cb;
                            cb.processResult(rc, var3, p.ctx);
                        }
                    }
                }
