...
public class FinalRequestProcessor implements RequestProcessor {
    ...
    public void processRequest(Request request) {
        ...
        try {
            ...
            switch(request.type) {
                ...
                case OpCode.create:
                    {
                        lastOp = "CREA";
                        var9 = new CreateResponse(rc.path);
                        err = Code.get(rc.err);
                        break;
                    }
                case OpCode.delete:
                ...
                case OpCode.setData:
                    {
                        lastOp = "SETD";
                        var9 = new SetDataResponse(rc.stat);
                        err = Code.get(rc.err);
                        break;
                    }
                case OpCode.setACL:
                    {
                        lastOp = "SETA";
                        var9 = new SetACLResponse(rc.stat);
                        err = Code.get(rc.err);
                        break;
                    }
                ...
                case OpCode.sync:
                    {
                        ...
                        var9 = new SyncResponse(syncRequest.getPath());
                        break;
                    }
                case OpCode.exists:
                    {
                ...
                case OpCode.getData:
                    {
                        ...
                        var9 = new GetDataResponse(b, stat);
                        break;
                    }
                ...
                case OpCode.getACL:
                    {
                        ...
                        var9 = new GetACLResponse(acl, stat);
                        break;
                    }
                case OpCode.getChildren:
                    {
                        ...
                        var9 = new GetChildrenResponse(children);
                        break;
                    }
                case OpCode.getChildren2:
                    {
                        ...
                        var9 = new GetChildren2Response(children, stat);
                        break;
                    }
            }
        ...
        cnxn.updateStatsForResponse(request.cxid, request.zxid, lastOp, request.createTime, System.currentTimeMillis());
        try {
            cnxn.sendResponse(hdr, var9, "response");
            if (closeSession) {
                cnxn.sendCloseSession();
            }
        } catch (IOException e) {
