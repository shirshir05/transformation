                    ...
                    try {
                        ...
                        if (joiningServers != null) {
                            for (String joiner : joiningServers) {
                                ...
                                QuorumServer var37 = new QuorumServer(sid, parts[1]);
                                if (var37.clientAddr == null || var37.electionAddr == null || var37.addr == null) {
                                ...
                                for (QuorumServer nqs : nextServers.values()) {
                                    ...
                                    var37.checkAddressDuplicate(nqs);
                                }
                                nextServers.remove(var37.id);
                                nextServers.put(Long.valueOf(var37.id), var37);
                            }
                        }
                    } catch (ConfigException e) {
