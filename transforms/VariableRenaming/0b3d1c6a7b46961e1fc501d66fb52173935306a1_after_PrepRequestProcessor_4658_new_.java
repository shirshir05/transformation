    ...
    protected void pRequest2Txn(int type, long zxid, Request request, Record record) throws KeeperException {
        ...
        switch(type) {
            case OpCode.create:
                ...
                CreateMode var10 = CreateMode.fromFlag(createRequest.getFlags());
                if (var10.isSequential()) {
                ...
                request.txn = new CreateTxn(path, createRequest.getData(), createRequest.getAcl(), var10.isEphemeral(), newCversion);
                StatPersisted s = new StatPersisted();
                if (var10.isEphemeral()) {
