            ...
            switch(request.type) {
                ...
                case OpCode.multi:
                     ...
                     */
                        ...
                        {
                            try {
                                pRequest2Txn(op.getType(), var8, request, subrequest);
                                ...
                                rollbackPendingChanges(var8, pendingChanges);
                            }
                        }
                    ...
                    request.hdr = new TxnHeader(request.sessionId, request.cxid, var8, zks.getTime(), request.type);
