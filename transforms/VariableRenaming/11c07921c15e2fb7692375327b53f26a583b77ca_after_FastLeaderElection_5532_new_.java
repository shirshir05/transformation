                ...
                if (n == null) {
                    ...
                    switch(n.state) {
                        case LOOKING:
                            ...
                            var4 = getVoteTracker(recvset, new Vote(proposedLeader, proposedZxid, logicalclock.get(), proposedEpoch));
                            if (var4.hasAllQuorums()) {
                             ...
                             */
                                if (n == null) {
                                    setPeerState(proposedLeader, var4);
                         ...
                         */
                            if (n.electionEpoch == logicalclock.get()) {
                                ...
                                var4 = getVoteTracker(recvset, new Vote(n.version, n.leader, n.zxid, n.electionEpoch, n.peerEpoch, n.state));
                                if (var4.hasAllQuorums() && checkLeader(recvset, n.leader, n.electionEpoch)) {
                                    setPeerState(n.leader, var4);
                         ...
                         */
                            ...
                            var4 = getVoteTracker(outofelection, new Vote(n.version, n.leader, n.zxid, n.electionEpoch, n.peerEpoch, n.state));
                            if (var4.hasAllQuorums() && checkLeader(outofelection, n.leader, n.electionEpoch)) {
                                synchronized (this) {
                                    logicalclock.set(n.electionEpoch);
                                    setPeerState(n.leader, var4);
                                }
