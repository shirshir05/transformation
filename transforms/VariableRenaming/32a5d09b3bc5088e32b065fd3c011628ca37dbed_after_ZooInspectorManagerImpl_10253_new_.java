        ...
        if (connected) {
            try {
                ...
                if (s != null) {
                    ...
                    for (ACL acl : acls) {
                        Map<String, String> var5 = new LinkedHashMap<String, String>();
                        var5.put(ACL_SCHEME, acl.getId().getScheme());
                        var5.put(ACL_ID, acl.getId().getId());
                        ...
                        var5.put(ACL_PERMS, sb.toString());
                        returnACLs.add(var5);
                    }
                }
