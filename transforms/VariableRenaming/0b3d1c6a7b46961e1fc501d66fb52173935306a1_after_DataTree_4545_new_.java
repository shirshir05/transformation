            ...
            switch(header.getType()) {
                ...
                case OpCode.multi:
                    ...
                    for (Txn subtxn : txns) {
                        ...
                        TxnHeader var19 = new TxnHeader(header.getClientId(), header.getCxid(), header.getZxid(), header.getTime(), subtxn.getType());
                        ProcessTxnResult subRc = processTxn(var19, record);
