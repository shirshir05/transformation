            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.REQUEST:
                        ...
                        Request var44;
                        if (type == OpCode.sync) {
                            var44 = new LearnerSyncRequest(this, sessionId, cxid, type, bb, qp.getAuthinfo());
                        } else {
                            var44 = new Request(null, sessionId, cxid, type, bb, qp.getAuthinfo());
                        }
                        var44.setOwner(this);
                        leader.zk.submitRequest(var44);
                        break;
                    default:
                }
            }
