    ...
    public void toSend(Long sid, ByteBuffer b) {
        ...
        if (self.getId() == sid) {
            ...
            /*
              ...
              */
            if (!queueSendMap.containsKey(sid)) {
                ArrayBlockingQueue<ByteBuffer> var2 = new ArrayBlockingQueue<ByteBuffer>(SEND_CAPACITY);
                queueSendMap.put(sid, var2);
                addToSendQueue(var2, b);
            } else {
                ArrayBlockingQueue<ByteBuffer> var2 = queueSendMap.get(sid);
                if (var2 != null) {
                    addToSendQueue(var2, b);
                } else {
