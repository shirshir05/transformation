...
public class FastLeaderElection implements Election {
    ...
    synchronized void updateProposal(long var0, long zxid, long epoch) {
        LOG.debug("Updating proposal: {} (newleader), 0x{} (newzxid), {} (oldleader), 0x{} (oldzxid)", var0, Long.toHexString(zxid), proposedLeader, Long.toHexString(proposedZxid));
        proposedLeader = var0;
        proposedZxid = zxid;
        proposedEpoch = epoch;
    }
