                ...
                while (true) {
                    ...
                    if (event instanceof WatcherEvent) {
                        ...
                        if (p.var4 == null) {
                            ...
                            StatCallback var4 = (StatCallback) p.var4;
                            if (rc == 0) {
                                if (p.response instanceof ExistsResponse) {
                                    var4.processResult(rc, path, p.ctx, ((ExistsResponse) p.response).getStat());
                                } else if (p.response instanceof SetDataResponse) {
                                    var4.processResult(rc, path, p.ctx, ((SetDataResponse) p.response).getStat());
                                } else if (p.response instanceof SetACLResponse) {
                                    var4.processResult(rc, path, p.ctx, ((SetACLResponse) p.response).getStat());
                                }
                            } else {
                                var4.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof GetDataResponse) {
                            DataCallback var4 = (DataCallback) p.var4;
                            GetDataResponse rsp = (GetDataResponse) p.response;
                            if (rc == 0) {
                                var4.processResult(rc, path, p.ctx, rsp.getData(), rsp.getStat());
                            } else {
                                var4.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetACLResponse) {
                            ACLCallback var4 = (ACLCallback) p.var4;
                            GetACLResponse rsp = (GetACLResponse) p.response;
                            if (rc == 0) {
                                var4.processResult(rc, path, p.ctx, rsp.getAcl(), rsp.getStat());
                            } else {
                                var4.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetChildrenResponse) {
                            ChildrenCallback var4 = (ChildrenCallback) p.var4;
                            GetChildrenResponse rsp = (GetChildrenResponse) p.response;
                            if (rc == 0) {
                                var4.processResult(rc, path, p.ctx, rsp.getChildren());
                            } else {
                                var4.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof CreateResponse) {
                            StringCallback var4 = (StringCallback) p.var4;
                            CreateResponse rsp = (CreateResponse) p.response;
                            if (rc == 0) {
                                var4.processResult(rc, path, p.ctx, rsp.getPath());
                            } else {
                                var4.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.var4 instanceof VoidCallback) {
                            VoidCallback var4 = (VoidCallback) p.var4;
                            var4.processResult(rc, path, p.ctx);
                        }
                    }
                }
