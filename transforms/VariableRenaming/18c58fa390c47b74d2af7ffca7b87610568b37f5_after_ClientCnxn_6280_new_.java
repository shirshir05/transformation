...
public class ClientCnxn {
    ...
    class SendThread extends Thread {
        ...
        private void startConnect() throws IOException {
            ...
            state = States.CONNECTING;
            InetSocketAddress var1 = hostProvider.next(1000);
            LOG.info("Opening socket connection to server " + var1);
            setName(getName().replaceAll("\\(.*\\)", "(" + var1.getHostName() + ":" + var1.getPort() + ")"));
            clientCnxnSocket.connect(var1);
        }
