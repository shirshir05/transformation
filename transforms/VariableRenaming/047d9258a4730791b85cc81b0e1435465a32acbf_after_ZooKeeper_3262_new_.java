...
public class ZooKeeper {
    ...
    public ZooKeeper(String host, int sessionTimeout, Watcher watcher) throws KeeperException, IOException {
        cnxn = new ClientCnxn(host, sessionTimeout, this);
        this.watcher = watcher;
    }

    public ZooKeeper(String host, int sessionTimeout, Watcher watcher, long sessionId, byte[] sessionPasswd) throws KeeperException, IOException {
     ...
     * @throws InterruptedException
     */
    public String create(String path, byte[] data, ArrayList<ACL> acl, int flags) throws KeeperException, InterruptedException {
        RequestHeader h = new RequestHeader();
    ...
    public void create(String path, byte[] data, ArrayList<ACL> acl, int flags, StringCallback cb, Object ctx) {
        RequestHeader h = new RequestHeader();
        h.setType(ZooDefs.OpCode.create);
        CreateRequest request = new CreateRequest();
        CreateResponse response = new CreateResponse();
    ...
    public byte[] getData(String path, boolean watch, Stat stat) throws KeeperException, InterruptedException {
        ...
        request.setPath(path);
        request.setWatch(watch);
        GetDataResponse var5 = new GetDataResponse();
        ReplyHeader r = cnxn.submitRequest(h, request, var5);
        if (r.getErr() != 0) {
            throw new KeeperException(r.getErr());
        }
        if (stat != null) {
            DataTree.copyStat(var5.getStat(), stat);
        }
        return var5.getData();
    }
     ...
     * @throws InterruptedException
     */
    public ArrayList<ACL> getACL(String path, Stat stat) throws KeeperException, InterruptedException {
        RequestHeader h = new RequestHeader();
     ...
     * @throws InterruptedException
     */
    public Stat setACL(String path, ArrayList<ACL> acl, int version) throws KeeperException, InterruptedException {
        RequestHeader h = new RequestHeader();
     ...
     */
    public void setACL(String path, ArrayList<ACL> acl, int version, StatCallback cb, Object ctx) {
        RequestHeader h = new RequestHeader();
        h.setType(ZooDefs.OpCode.setACL);
        SetACLRequest request = new SetACLRequest();
        request.setPath(path);
     ...
     * @throws InterruptedException
     */
    public ArrayList<String> getChildren(String path, boolean watch) throws KeeperException, InterruptedException {
        RequestHeader h = new RequestHeader();
