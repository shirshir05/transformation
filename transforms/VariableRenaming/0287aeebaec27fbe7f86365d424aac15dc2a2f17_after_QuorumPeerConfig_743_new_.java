    ...
    public void parseProperties(Properties zkProp) throws IOException, ConfigException {
        ...
        for (Entry<Object, Object> entry : zkProp.entrySet()) {
            ...
            if (key.equals("dataDir")) {
                ...
                numGroups++;
                String[] parts = value.split(":");
                for (String var17 : parts) {
                    long sid = Long.parseLong(var17);
        ...
        if (servers.size() == 0) {
             ...
             */
            if (electionAlg != 0) {
                for (QuorumServer var17 : servers.values()) {
                    if (var17.electionAddr == null)
                        throw new IllegalArgumentException("Missing election port for server: " + var17.id);
                }
            }
            /*
            ...
            if (serverGroup.size() > 0) {
                 ...
                 */
                for (QuorumServer var17 : servers.values()) {
                    if (!serverWeight.containsKey(var17.id))
                        serverWeight.put(var17.id, (long) 1);
                }
                /*
