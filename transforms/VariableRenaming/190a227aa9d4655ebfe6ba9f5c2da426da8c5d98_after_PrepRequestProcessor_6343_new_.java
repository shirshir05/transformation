...
public class PrepRequestProcessor extends ZooKeeperCriticalThread implements RequestProcessor {
     ...
     * @param record
     */
    protected void pRequest2Txn(int type, long zxid, Request request, Record var3, boolean deserialize) throws KeeperException, IOException, RequestProcessorException {
        ...
        switch(type) {
            ...
            case OpCode.createContainer:
                {
                    pRequest2TxnCreate(type, request, var3, deserialize);
                    break;
                }
            ...
            case OpCode.delete:
                ...
                DeleteRequest deleteRequest = (DeleteRequest) var3;
                if (deserialize) {
            ...
            case OpCode.setData:
                zks.sessionTracker.checkSession(request.sessionId, request.getOwner());
                SetDataRequest setDataRequest = (SetDataRequest) var3;
                if (deserialize) {
            ...
            case OpCode.reconfig:
                ...
                ReconfigRequest reconfigRequest = (ReconfigRequest) var3;
            ...
            case OpCode.setACL:
                zks.sessionTracker.checkSession(request.sessionId, request.getOwner());
                SetACLRequest setAclRequest = (SetACLRequest) var3;
                if (deserialize) {
            ...
            case OpCode.check:
                zks.sessionTracker.checkSession(request.sessionId, request.getOwner());
                CheckVersionRequest checkVersionRequest = (CheckVersionRequest) var3;
                if (deserialize) {
