    ...
    class SendWorker extends Thread {
        ...
        public void run() {
            try {
                ...
                LOG.error("Failed to send last message. Shutting down thread.", var4);
                this.finish();
            }
            try {
                while (running && !shutdown && sock != null) {
                    ...
                    try {
                        ...
                        LOG.warn("Interrupted while waiting for message on queue", var4);
                    }
                }
            } catch (Exception var4) {
                LOG.warn("Exception when using channel: for id " + sid + " my id = " + self.getId() + " error = " + var4);
            }
            this.finish();
