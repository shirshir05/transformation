...
public class FileTxnSnapLog {
    ...
    public void save(DataTree dataTree, ConcurrentHashMap<Long, Integer> sessionsWithTimeouts, boolean syncSnap) throws IOException {
        long var3 = dataTree.lastProcessedZxid;
        File snapshotFile = new File(snapDir, Util.makeSnapshotName(var3));
        LOG.info("Snapshotting: 0x{} to {}", Long.toHexString(var3), snapshotFile);
