...
public class NIOServerCnxn implements Watcher, ServerCnxn {
    ...
    public void close() {
        ...
        try {
            ...
            LOG.warn("ignoring exception during socket close", var0);
        }
        try {
            sock.close();
        } catch (IOException var0) {
            LOG.warn("ignoring exception during socketchannel close", var0);
        }
        sock = null;
        if (sk != null) {
            try {
                ...
                LOG.warn("ignoring exception during selectionkey cancel", var0);
            }
        }
    }
