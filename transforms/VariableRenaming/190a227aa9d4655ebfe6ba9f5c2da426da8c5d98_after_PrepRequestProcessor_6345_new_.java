    ...
    protected void pRequest2Txn(int type, long zxid, Request request, Record record, boolean deserialize) throws KeeperException, IOException, RequestProcessorException {
        ...
        switch(type) {
            ...
            case OpCode.deleteContainer:
                {
                    ...
                    parentRecord.var5 = precalculateDigest(DigestOpCode.UPDATE, parentPath, parentRecord.data, parentRecord.stat);
                    addChangeRecord(parentRecord);
                    nodeRecord = new ChangeRecord(request.getHdr().getZxid(), path, null, -1, null);
                    nodeRecord.var5 = precalculateDigest(DigestOpCode.REMOVE, path);
                    setTxnDigest(request, nodeRecord.var5);
            ...
            case OpCode.setData:
                ...
                nodeRecord.var5 = precalculateDigest(DigestOpCode.UPDATE, path, nodeRecord.data, nodeRecord.stat);
                setTxnDigest(request, nodeRecord.var5);
                addChangeRecord(nodeRecord);
                break;
            case OpCode.reconfig:
                ...
                nodeRecord.var5 = precalculateDigest(DigestOpCode.NOOP, ZooDefs.CONFIG_NODE, nodeRecord.data, nodeRecord.stat);
                setTxnDigest(request, nodeRecord.var5);
                addChangeRecord(nodeRecord);
                break;
            case OpCode.setACL:
            ...
            case OpCode.closeSession:
                ...
                synchronized (zks.outstandingChanges) {
                    ...
                    for (String path2Delete : es) {
                        ...
                        nodeRecord.var5 = precalculateDigest(DigestOpCode.REMOVE, path2Delete);
                        addChangeRecord(nodeRecord);
                    }
