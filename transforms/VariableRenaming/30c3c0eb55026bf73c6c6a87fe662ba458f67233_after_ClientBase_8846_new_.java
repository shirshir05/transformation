...
public abstract class ClientBase extends TestCase {
    ...
    protected ZooKeeper createClient(CountdownWatcher watcher, String var1) throws IOException, InterruptedException {
        ZooKeeper zk = new ZooKeeper(var1, 9000, watcher);
