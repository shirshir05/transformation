...
public class LearnerHandler extends Thread {
    ...
    static public String packetToString(QuorumPacket var0) {
        if (true)
            return null;
        String type = null;
        String mess = null;
        ...
        switch(var0.getType()) {
            ...
            case Leader.PROPOSAL:
                type = "PROPOSAL";
                BinaryInputArchive ia = BinaryInputArchive.getArchive(new ByteArrayInputStream(var0.getData()));
            ...
            case Leader.UPTODATE:
                ...
                break;
            default:
                type = "UNKNOWN" + var0.getType();
        }
        String entry = null;
        if (type != null) {
            entry = type + " " + Long.toHexString(var0.getZxid()) + " " + mess;
        }
        return entry;
    }
