...
public class DataTree {
     ...
     */
    public String createNode(String var0, byte[] data, List<ACL> acl, long ephemeralOwner, long zxid, long time) throws KeeperException.NoNodeException, KeeperException.NodeExistsException {
        ...
        dataWatches.triggerWatch(var0, Event.EventType.NodeCreated);
