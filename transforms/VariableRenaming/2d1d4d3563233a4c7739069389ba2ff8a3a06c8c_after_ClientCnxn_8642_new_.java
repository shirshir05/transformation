                ...
                while (true) {
                    ...
                    if (event instanceof WatcherEvent) {
                        ...
                        if (p.var5 == null) {
                            ...
                            StatCallback var5 = (StatCallback) p.var5;
                            if (rc == 0) {
                                if (p.response instanceof ExistsResponse) {
                                    var5.processResult(rc, path, p.ctx, ((ExistsResponse) p.response).getStat());
                                } else if (p.response instanceof SetDataResponse) {
                                    var5.processResult(rc, path, p.ctx, ((SetDataResponse) p.response).getStat());
                                } else if (p.response instanceof SetACLResponse) {
                                    var5.processResult(rc, path, p.ctx, ((SetACLResponse) p.response).getStat());
                                }
                            } else {
                                var5.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof GetDataResponse) {
                            DataCallback var5 = (DataCallback) p.var5;
                            GetDataResponse rsp = (GetDataResponse) p.response;
                            if (rc == 0) {
                                var5.processResult(rc, path, p.ctx, rsp.getData(), rsp.getStat());
                            } else {
                                var5.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetACLResponse) {
                            ACLCallback var5 = (ACLCallback) p.var5;
                            GetACLResponse rsp = (GetACLResponse) p.response;
                            if (rc == 0) {
                                var5.processResult(rc, path, p.ctx, rsp.getAcl(), rsp.getStat());
                            } else {
                                var5.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetChildrenResponse) {
                            ChildrenCallback var5 = (ChildrenCallback) p.var5;
                            GetChildrenResponse rsp = (GetChildrenResponse) p.response;
                            if (rc == 0) {
                                var5.processResult(rc, path, p.ctx, rsp.getChildren());
                            } else {
                                var5.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof CreateResponse) {
                            StringCallback var5 = (StringCallback) p.var5;
                            CreateResponse rsp = (CreateResponse) p.response;
                            if (rc == 0) {
                                var5.processResult(rc, path, p.ctx, rsp.getPath());
                            } else {
                                var5.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.var5 instanceof VoidCallback) {
                            VoidCallback var5 = (VoidCallback) p.var5;
                            var5.processResult(rc, path, p.ctx);
                        }
                    }
                }
