...
public class FileTxnSnapLog {
     ...
     * @throws IOException
     */
    public long restore(DataTree var0, Map<Long, Integer> sessions, PlayBackListener listener) throws IOException {
        long deserializeResult = snapLog.deserialize(var0, sessions);
        ...
        if (-1L == deserializeResult) {
            ...
            if (trustEmptyDB) {
                 ...
                 *       or use Map on save() */
                save(var0, (ConcurrentHashMap<Long, Integer>) sessions, false);
                /* return a zxid of 0, since we know the database is empty */
                return 0L;
            } else {
                /* return a zxid of -1, since we are possibly missing data */
                LOG.warn("Unexpected empty data tree, setting zxid to -1");
                var0.lastProcessedZxid = -1L;
                return -1L;
            }
        }
        TxnIterator itr = txnLog.read(var0.lastProcessedZxid + 1);
        long highestZxid = var0.lastProcessedZxid;
        TxnHeader hdr;
        try {
            while (true) {
                ...
                try {
                    processTransaction(hdr, var0, sessions, itr.getTxn());
