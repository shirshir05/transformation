...
public class FastLeaderElection implements Election {
    ...
    public Vote lookForLeader() throws InterruptedException {
        ...
        try {
             ...
             */
            Map<Long, Vote> var2 = new HashMap<Long, Vote>();
            ...
            while ((self.getPeerState() == ServerState.LOOKING) && (!stop)) {
                ...
                if (n == null) {
                    ...
                    switch(n.state) {
                         ...
                         */
                            var2.put(n.sid, new Vote(n.version, n.leader, n.zxid, n.electionEpoch, n.peerEpoch, n.state));
                            voteSet = getVoteTracker(var2, new Vote(n.version, n.leader, n.zxid, n.electionEpoch, n.peerEpoch, n.state));
                            if (voteSet.hasAllQuorums() && checkLeader(var2, n.leader, n.electionEpoch)) {
                                synchronized (this) {
                                    logicalclock.set(n.electionEpoch);
                                    setPeerState(n.leader, voteSet);
                                }
