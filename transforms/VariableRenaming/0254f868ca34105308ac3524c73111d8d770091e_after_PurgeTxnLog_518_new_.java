...
public class PurgeTxnLog {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<File> var11 = new ArrayList<File>(Arrays.asList(dataDir.listFiles(new MyFileFilter("log."))));
        // add all non-excluded snapshot files to the deletion list
        var11.addAll(Arrays.asList(snapDir.listFiles(new MyFileFilter("snapshot."))));
