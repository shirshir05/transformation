            ...
            switch(request.type) {
                ...
                case OpCode.multi:
                     ...
                     */
                        ...
                        {
                            try {
                                pRequest2Txn(op.getType(), var11, request, subrequest, false);
                                ...
                                rollbackPendingChanges(var11, pendingChanges);
                            }
                        }
                    ...
                    request.setHdr(new TxnHeader(request.sessionId, request.cxid, var11, Time.currentWallTime(), request.type));
