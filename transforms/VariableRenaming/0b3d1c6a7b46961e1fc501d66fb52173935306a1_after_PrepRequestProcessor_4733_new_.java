                     ...
                     */
                        ...
                        } else /* Prep the request and convert to a Txn */
                        {
                            try {
                                ...
                                request.hdr.setType(OpCode.error);
                                request.txn = new ErrorTxn(var18.code().intValue());
                                LOG.error(">>>> Got user-level KeeperException when processing " + request.toString() + " Error Path:" + var18.getPath() + " Error:" + var18.getMessage());
