    ...
    protected void pRequest2Txn(int type, long zxid, Request request, Record record) throws KeeperException {
        ...
        switch(type) {
            ...
            case OpCode.delete:
                ...
                int var18 = deleteRequest.getVersion();
                if (var18 != -1 && nodeRecord.stat.getVersion() != var18) {
            ...
            case OpCode.setData:
                ...
                var18 = setDataRequest.getVersion();
                int currentVersion = nodeRecord.stat.getVersion();
                if (var18 != -1 && var18 != currentVersion) {
                    throw new KeeperException.BadVersionException(path);
                }
                var18 = currentVersion + 1;
                request.txn = new SetDataTxn(path, setDataRequest.getData(), var18);
                nodeRecord = nodeRecord.duplicate(request.hdr.getZxid());
                nodeRecord.stat.setVersion(var18);
            ...
            case OpCode.setACL:
                ...
                var18 = setAclRequest.getVersion();
                currentVersion = nodeRecord.stat.getAversion();
                if (var18 != -1 && var18 != currentVersion) {
                    throw new KeeperException.BadVersionException(path);
                }
                var18 = currentVersion + 1;
                request.txn = new SetACLTxn(path, setAclRequest.getAcl(), var18);
                nodeRecord = nodeRecord.duplicate(request.hdr.getZxid());
                nodeRecord.stat.setAversion(var18);
                addChangeRecord(nodeRecord);
                break;
            ...
            case OpCode.check:
                ...
                var18 = checkVersionRequest.getVersion();
                currentVersion = nodeRecord.stat.getVersion();
                if (var18 != -1 && var18 != currentVersion) {
                    throw new KeeperException.BadVersionException(path);
                }
                var18 = currentVersion + 1;
                request.txn = new CheckVersionTxn(path, var18);
                break;
        }
    }
