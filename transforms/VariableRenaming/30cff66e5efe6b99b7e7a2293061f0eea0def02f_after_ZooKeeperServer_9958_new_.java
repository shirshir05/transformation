...
public class ZooKeeperServer implements SessionExpirer, ServerStats.Provider {
    ...
    protected void revalidateSession(ServerCnxn cnxn, long var1, int sessionTimeout) throws IOException {
        boolean rc = sessionTracker.touchSession(var1, sessionTimeout);
        if (LOG.isTraceEnabled()) {
            ZooTrace.logTraceMessage(LOG, ZooTrace.SESSION_TRACE_MASK, "Session 0x" + Long.toHexString(var1) + " is valid: " + rc);
        }
