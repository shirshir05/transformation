...
public class PrepRequestProcessor extends ZooKeeperCriticalThread implements RequestProcessor {
    ...
    protected void pRequest(Request request) throws RequestProcessorException {
        ...
        try {
            switch(request.type) {
                ...
                case OpCode.multi:
                     ...
                     */
                        ...
                        ByteBuffer var21 = ByteBuffer.wrap(baos.toByteArray());
                        txns.add(new Txn(type, var21.array()));
                    }
            ...
            ByteBuffer var21 = request.request;
            if (var21 != null) {
                var21.rewind();
                while (var21.hasRemaining()) {
                    sb.append(Integer.toHexString(var21.get() & 0xff));
                }
            } else {
