    ...
    protected void pRequest2Txn(int type, long zxid, Request request, Record record) throws KeeperException {
        ...
        switch(type) {
            ...
            case OpCode.delete:
                ...
                int var19 = deleteRequest.getVersion();
                if (var19 != -1 && nodeRecord.stat.getVersion() != var19) {
            ...
            case OpCode.setData:
                ...
                var19 = setDataRequest.getVersion();
                int currentVersion = nodeRecord.stat.getVersion();
                if (var19 != -1 && var19 != currentVersion) {
                    throw new KeeperException.BadVersionException(path);
                }
                var19 = currentVersion + 1;
                request.txn = new SetDataTxn(path, setDataRequest.getData(), var19);
                nodeRecord = nodeRecord.duplicate(request.hdr.getZxid());
                nodeRecord.stat.setVersion(var19);
            ...
            case OpCode.setACL:
                ...
                var19 = setAclRequest.getVersion();
                currentVersion = nodeRecord.stat.getAversion();
                if (var19 != -1 && var19 != currentVersion) {
                    throw new KeeperException.BadVersionException(path);
                }
                var19 = currentVersion + 1;
                request.txn = new SetACLTxn(path, listACL, var19);
                nodeRecord = nodeRecord.duplicate(request.hdr.getZxid());
                nodeRecord.stat.setAversion(var19);
                addChangeRecord(nodeRecord);
                break;
            ...
            case OpCode.check:
                ...
                var19 = checkVersionRequest.getVersion();
                currentVersion = nodeRecord.stat.getVersion();
                if (var19 != -1 && var19 != currentVersion) {
                    throw new KeeperException.BadVersionException(path);
                }
                var19 = currentVersion + 1;
                request.txn = new CheckVersionTxn(path, var19);
                break;
        }
    }
