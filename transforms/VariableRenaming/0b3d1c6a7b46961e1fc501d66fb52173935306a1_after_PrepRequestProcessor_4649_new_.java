...
public class PrepRequestProcessor extends Thread implements RequestProcessor {
    ...
    protected void pRequest2Txn(int type, long var1, Request request, Record record) throws KeeperException {
        request.hdr = new TxnHeader(request.sessionId, request.cxid, var1, zks.getTime(), type);
        switch(type) {
            case OpCode.create:
