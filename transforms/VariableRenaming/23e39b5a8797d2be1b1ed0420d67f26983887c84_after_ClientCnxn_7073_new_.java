...
class ClientCnxn {
    ...
    class SendThread extends Thread {
        ...
        private void primeConnection(SelectionKey k) throws IOException {
            ...
            bb.rewind();
            synchronized (outgoingQueue) {
                for (AuthData var5 : authInfo) {
                    outgoingQueue.addFirst(new Packet(new RequestHeader(-4, OpCode.auth), null, new AuthPacket(0, var5.scheme, var5.data), null, null, null));
                }
