...
public class FileSnap implements SnapShot {
     ...
     */
    public long deserialize(DataTree var0, Map<Long, Integer> sessions) throws IOException {
        // we should  give up
        ...
        var0.lastProcessedZxid = Util.getZxidFromName(snap.getName(), "snapshot");
