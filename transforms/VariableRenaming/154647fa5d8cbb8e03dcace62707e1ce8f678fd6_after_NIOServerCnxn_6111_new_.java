...
public class NIOServerCnxn implements Watcher, ServerCnxn {
    ...
    public void close() {
        ...
        try {
            ...
            LOG.warn("Failed to unregister with JMX", var2);
        }
        ...
        try {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("ignoring exception during output shutdown", var2);
            }
        }
        try {
            ...
            // This is a relatively common exception that we can't avoid
            if (LOG.isDebugEnabled()) {
                LOG.debug("ignoring exception during input shutdown", var2);
            }
        }
        try {
            sock.socket().close();
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("ignoring exception during socket close", var2);
            }
        }
        try {
            sock.close();
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("ignoring exception during socketchannel close", var2);
            }
        }
        sock = null;
        if (sk != null) {
            try {
                ...
                if (LOG.isDebugEnabled()) {
                    LOG.debug("ignoring exception during selectionkey cancel", var2);
                }
            }
        }
    }
