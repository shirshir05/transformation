...
public class NIOServerCnxn implements Watcher, ServerCnxn {
    ...
    public void close() {
        ...
        try {
            ...
            LOG.warn("Failed to unregister with JMX", var4);
        }
        ...
        try {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("ignoring exception during output shutdown", var4);
            }
        }
        try {
            ...
            // This is a relatively common exception that we can't avoid
            if (LOG.isDebugEnabled()) {
                LOG.debug("ignoring exception during input shutdown", var4);
            }
        }
        try {
            sock.socket().close();
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("ignoring exception during socket close", var4);
            }
        }
        try {
            sock.close();
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("ignoring exception during socketchannel close", var4);
            }
        }
        sock = null;
        if (sk != null) {
            try {
                ...
                if (LOG.isDebugEnabled()) {
                    LOG.debug("ignoring exception during selectionkey cancel", var4);
                }
            }
        }
    }
