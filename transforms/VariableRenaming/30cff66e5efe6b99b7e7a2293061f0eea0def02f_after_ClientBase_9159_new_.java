...
public abstract class ClientBase extends ZKTestCase {
    ...
    public void tearDown() throws Exception {
         ...
         * only place sun has implemented as part of the mgmt bean api.
         */
        OperatingSystemMXBean var0 = ManagementFactory.getOperatingSystemMXBean();
        if (var0 != null && var0 instanceof UnixOperatingSystemMXBean) {
            UnixOperatingSystemMXBean unixos = (UnixOperatingSystemMXBean) var0;
