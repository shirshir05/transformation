    ...
    public void run() {
        try {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        LOG.warn("Unexpected interruption", var30);
                    }
                }
            }.start();
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.REVALIDATE:
                        ...
                        if (valid) {
                            ...
                            } catch (SessionExpiredException var30) {
                                LOG.error("Somehow session " + Long.toHexString(id) + " expired right after being renewed! (impossible)", var30);
                            }
                        }
                        if (LOG.isTraceEnabled()) {
            ...
            if (sock != null && !sock.isClosed()) {
                LOG.error("Unexpected exception causing shutdown while sock " + "still open", var30);
            }
        } catch (InterruptedException var30) {
            LOG.error("Unexpected exception causing shutdown", var30);
        } finally {
            ...
            try {
                ...
                LOG.warn("Ignoring unexpected exception", var30);
            }
            shutdown();
        }
    }
