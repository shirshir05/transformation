        ...
        try {
            switch(request.type) {
                ...
                case OpCode.setData:
                    ...
                    break;
                case OpCode.reconfig:
                    ReconfigRequest var5 = new ReconfigRequest();
                    ByteBufferInputStream.byteBuffer2Record(request.request, var5);
                    pRequest2Txn(request.type, zks.getNextZxid(), request, var5, true);
                    break;
                case OpCode.setACL:
