    ...
    protected void pRequest2Txn(int type, long zxid, Request request, Record record) throws KeeperException {
        ...
        switch(type) {
            case OpCode.create:
                ...
                ChangeRecord var8 = getRecordForPath(parentPath);
                checkACL(zks, var8.acl, ZooDefs.Perms.CREATE, request.authInfo);
                int parentCVersion = var8.stat.getCversion();
                ...
                boolean ephemeralParent = var8.stat.getEphemeralOwner() != 0;
                if (ephemeralParent) {
                    throw new KeeperException.NoChildrenForEphemeralsException(path);
                }
                int newCversion = var8.stat.getCversion() + 1;
                ...
                var8 = var8.duplicate(request.hdr.getZxid());
                var8.childCount++;
                var8.stat.setCversion(newCversion);
            ...
            case OpCode.delete:
                ...
                var8 = getRecordForPath(parentPath);
                ChangeRecord nodeRecord = getRecordForPath(path);
                checkACL(zks, var8.acl, ZooDefs.Perms.DELETE, request.authInfo);
