...
public class Learner {
     ...
     * @throws InterruptedException
     */
    protected void syncWithLeader(long var0) throws IOException, InterruptedException {
        ...
        synchronized (zk) {
            ...
            if (LOG.isInfoEnabled()) {
                LOG.info("Setting leader epoch " + Long.toHexString(var0 >> 32L));
            }
            long lastQueued = 0;
