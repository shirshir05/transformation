    ...
    private class MonitorCommand extends CommandThread {
        ...
        public void commandRun() {
            ...
            if (stats.getServerState() == "leader") {
                Leader var4 = ((LeaderZooKeeperServer) zk).getLeader();
                print("followers", var4.learners.size());
                print("synced_followers", var4.forwardingFollowers.size());
                print("pending_syncs", var4.pendingSyncs.size());
            }
        }
