        ...
        try {
            switch(request.type) {
                ...
                case OpCode.check:
                    ...
                    break;
                case OpCode.multi:
                    MultiTransactionRecord var8 = new MultiTransactionRecord();
                    try {
                        ByteBufferInputStream.byteBuffer2Record(request.request, var8);
                    } catch (IOException e) {
                    ...
                    Map<String, ChangeRecord> pendingChanges = getPendingChanges(var8);
                    for (Op op : var8) {
