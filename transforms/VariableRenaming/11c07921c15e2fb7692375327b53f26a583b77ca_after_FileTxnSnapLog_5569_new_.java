...
public class FileTxnSnapLog {
    ...
    public long restore(DataTree dt, Map<Long, Integer> sessions, PlayBackListener listener) throws IOException {
        ...
        DataTree.ZxidDigest var9 = dt.getDigestFromLoadedSnapshot();
        if (var9 != null) {
            LOG.warn("Highest txn zxid 0x{} is not covering the snapshot digest zxid 0x{}, " + "which might lead to inconsistent state", Long.toHexString(highestZxid), Long.toHexString(var9.getZxid()));
        }
        return highestZxid;
    }
