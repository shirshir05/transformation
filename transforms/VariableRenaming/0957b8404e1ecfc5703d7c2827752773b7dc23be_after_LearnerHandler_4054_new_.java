            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.REVALIDATE:
                        ...
                        dos.writeLong(id);
                        boolean var25 = leader.zk.touch(id, to);
                        if (var25) {
                            try {
                                // owns the session
                        ...
                        if (LOG.isTraceEnabled()) {
                            ZooTrace.logTraceMessage(LOG, ZooTrace.SESSION_TRACE_MASK, "Session 0x" + Long.toHexString(id) + " is valid: " + var25);
                        }
                        dos.writeBoolean(var25);
