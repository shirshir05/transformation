...
public class ZooKeeperRetry extends ZooKeeper {
    ...
    @Override
    public String create(String path, byte[] data, List<ACL> var2, CreateMode createMode) throws KeeperException, InterruptedException {
        int count = 0;
        do {
            try {
                return super.create(path, data, var2, createMode);
