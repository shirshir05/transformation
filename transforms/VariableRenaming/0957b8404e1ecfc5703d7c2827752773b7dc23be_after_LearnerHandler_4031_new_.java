        ...
        try {
            ...
            synchronized (leader.zk.committedLog) {
                if (leader.zk.committedLog.size() != 0) {
                    if ((leader.zk.maxCommittedLog >= var2) && (leader.zk.minCommittedLog <= var2)) {
            ...
            if (logTxns && (var2 > leader.zk.maxCommittedLog)) {
            ...
            if (packetToSend == Leader.SNAP) {
                LOG.warn("Sending snapshot last zxid of peer is 0x" + Long.toHexString(var2) + " " + " zxid of leader is 0x" + Long.toHexString(leaderLastZxid));
                // Dump data to peer
