...
public class QuorumCnxManager {
    ...
    synchronized void connectOne(long var0) {
        ...
        synchronized (self) {
            ...
            if (self.getView().containsKey(var0)) {
                knownId = true;
                if (connectOne(var0, self.getView().get(var0).electionAddr))
                    return;
            }
            if (self.getLastSeenQuorumVerifier() != null && self.getLastSeenQuorumVerifier().getAllMembers().containsKey(var0) && (!knownId || (self.getLastSeenQuorumVerifier().getAllMembers().get(var0).electionAddr != self.getView().get(var0).electionAddr))) {
                knownId = true;
                if (connectOne(var0, self.getLastSeenQuorumVerifier().getAllMembers().get(var0).electionAddr))
                    return;
            }
            if (!knownId) {
