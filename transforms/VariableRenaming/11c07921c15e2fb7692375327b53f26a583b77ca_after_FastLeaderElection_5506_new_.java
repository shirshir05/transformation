...
public class FastLeaderElection implements Election {
     ...
     * current vote.
     */
    protected boolean totalOrderPredicate(long newId, long newZxid, long var2, long curId, long curZxid, long curEpoch) {
        LOG.debug("id: {}, proposed id: {}, zxid: 0x{}, proposed zxid: 0x{}", newId, curId, Long.toHexString(newZxid), Long.toHexString(curZxid));
        if (self.getQuorumVerifier().getWeight(newId) == 0) {
            return false;
        }
        return ((var2 > curEpoch) || ((var2 == curEpoch) && ((newZxid > curZxid) || ((newZxid == curZxid) && (newId > curId)))));
    }
