                ...
                while (true) {
                    ...
                    if (event instanceof WatcherEvent) {
                        ...
                        if (p.var9 == null) {
                            ...
                            StatCallback var9 = (StatCallback) p.var9;
                            if (rc == 0) {
                                if (p.response instanceof ExistsResponse) {
                                    var9.processResult(rc, path, p.ctx, ((ExistsResponse) p.response).getStat());
                                } else if (p.response instanceof SetDataResponse) {
                                    var9.processResult(rc, path, p.ctx, ((SetDataResponse) p.response).getStat());
                                } else if (p.response instanceof SetACLResponse) {
                                    var9.processResult(rc, path, p.ctx, ((SetACLResponse) p.response).getStat());
                                }
                            } else {
                                var9.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof GetDataResponse) {
                            DataCallback var9 = (DataCallback) p.var9;
                            GetDataResponse rsp = (GetDataResponse) p.response;
                            if (rc == 0) {
                                var9.processResult(rc, path, p.ctx, rsp.getData(), rsp.getStat());
                            } else {
                                var9.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetACLResponse) {
                            ACLCallback var9 = (ACLCallback) p.var9;
                            GetACLResponse rsp = (GetACLResponse) p.response;
                            if (rc == 0) {
                                var9.processResult(rc, path, p.ctx, rsp.getAcl(), rsp.getStat());
                            } else {
                                var9.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetChildrenResponse) {
                            ChildrenCallback var9 = (ChildrenCallback) p.var9;
                            GetChildrenResponse rsp = (GetChildrenResponse) p.response;
                            if (rc == 0) {
                                var9.processResult(rc, path, p.ctx, rsp.getChildren());
                            } else {
                                var9.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof CreateResponse) {
                            StringCallback var9 = (StringCallback) p.var9;
                            CreateResponse rsp = (CreateResponse) p.response;
                            if (rc == 0) {
                                var9.processResult(rc, path, p.ctx, rsp.getPath());
                            } else {
                                var9.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.var9 instanceof VoidCallback) {
                            VoidCallback var9 = (VoidCallback) p.var9;
                            var9.processResult(rc, path, p.ctx);
                        }
                    }
                }
