    ...
    public void processPacket(ServerCnxn cnxn, ByteBuffer incomingBuffer) throws IOException {
        ...
        if (h.getType() == OpCode.auth) {
            ...
            if (ap == null || (ap.handleAuthentication(cnxn, authPacket.getAuth()) != KeeperException.Code.OK)) {
                ...
                // send a response...
                ReplyHeader var8 = new ReplyHeader(h.getXid(), 0, KeeperException.Code.AUTHFAILED.intValue());
                cnxn.sendResponse(var8, null, null);
                ...
                ReplyHeader var8 = new ReplyHeader(h.getXid(), 0, KeeperException.Code.OK.intValue());
                cnxn.sendResponse(var8, null, null);
            }
            return;
        } else {
