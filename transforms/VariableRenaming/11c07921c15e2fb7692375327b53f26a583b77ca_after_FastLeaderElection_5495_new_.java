...
public class FastLeaderElection implements Election {
    ...
    private void leaveInstance(Vote var0) {
        LOG.debug("About to leave FLE instance: leader={}, zxid=0x{}, my id={}, my state={}", var0.getId(), Long.toHexString(var0.getZxid()), self.getId(), self.getPeerState());
        recvqueue.clear();
    }
