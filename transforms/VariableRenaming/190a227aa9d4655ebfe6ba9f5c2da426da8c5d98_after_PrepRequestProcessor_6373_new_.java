                    ...
                    try {
                        if (leavingServers != null) {
                            for (String leaving : leavingServers) {
                                long var33 = Long.parseLong(leaving);
                                nextServers.remove(var33);
                            }
                        }
                        if (joiningServers != null) {
                            for (String joiner : joiningServers) {
                                ...
                                Long var33 = Long.parseLong(parts[0].substring(parts[0].lastIndexOf('.') + 1));
                                QuorumServer qs = new QuorumServer(var33, parts[1]);
