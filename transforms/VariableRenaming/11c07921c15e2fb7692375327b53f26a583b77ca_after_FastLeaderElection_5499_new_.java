...
public class FastLeaderElection implements Election {
    ...
    private void sendNotifications() {
        for (long sid : self.getCurrentAndNextConfigVoters()) {
            ...
            ToSend notmsg = new ToSend(ToSend.mType.notification, proposedLeader, proposedZxid, logicalclock.get(), QuorumPeer.ServerState.LOOKING, sid, proposedEpoch, var1.toString().getBytes());
