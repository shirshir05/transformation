...
class ClientCnxn {
    ...
    public ReplyHeader submitRequest(RequestHeader h, Record var1, Record response, WatchRegistration watchRegistration) throws InterruptedException {
        ReplyHeader r = new ReplyHeader();
        Packet packet = queuePacket(h, r, var1, response, null, null, null, watchRegistration);
        synchronized (packet) {
