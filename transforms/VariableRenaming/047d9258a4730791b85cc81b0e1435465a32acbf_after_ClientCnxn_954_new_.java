                ...
                while (true) {
                    ...
                    if (event instanceof WatcherEvent) {
                        ...
                        if (p.var11 == null) {
                            ...
                            StatCallback var11 = (StatCallback) p.var11;
                            if (rc == 0) {
                                if (p.response instanceof ExistsResponse) {
                                    var11.processResult(rc, path, p.ctx, ((ExistsResponse) p.response).getStat());
                                } else if (p.response instanceof SetDataResponse) {
                                    var11.processResult(rc, path, p.ctx, ((SetDataResponse) p.response).getStat());
                                } else if (p.response instanceof SetACLResponse) {
                                    var11.processResult(rc, path, p.ctx, ((SetACLResponse) p.response).getStat());
                                }
                            } else {
                                var11.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof GetDataResponse) {
                            DataCallback var11 = (DataCallback) p.var11;
                            GetDataResponse rsp = (GetDataResponse) p.response;
                            if (rc == 0) {
                                var11.processResult(rc, path, p.ctx, rsp.getData(), rsp.getStat());
                            } else {
                                var11.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetACLResponse) {
                            ACLCallback var11 = (ACLCallback) p.var11;
                            GetACLResponse rsp = (GetACLResponse) p.response;
                            if (rc == 0) {
                                var11.processResult(rc, path, p.ctx, rsp.getAcl(), rsp.getStat());
                            } else {
                                var11.processResult(rc, path, p.ctx, null, null);
                            }
                        } else if (p.response instanceof GetChildrenResponse) {
                            ChildrenCallback var11 = (ChildrenCallback) p.var11;
                            GetChildrenResponse rsp = (GetChildrenResponse) p.response;
                            if (rc == 0) {
                                var11.processResult(rc, path, p.ctx, rsp.getChildren());
                            } else {
                                var11.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.response instanceof CreateResponse) {
                            StringCallback var11 = (StringCallback) p.var11;
                            CreateResponse rsp = (CreateResponse) p.response;
                            if (rc == 0) {
                                var11.processResult(rc, path, p.ctx, rsp.getPath());
                            } else {
                                var11.processResult(rc, path, p.ctx, null);
                            }
                        } else if (p.var11 instanceof VoidCallback) {
                            VoidCallback var11 = (VoidCallback) p.var11;
                            var11.processResult(rc, path, p.ctx);
                        }
                    }
                }
