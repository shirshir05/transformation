...
public class DataTree {
    ...
    public void setWatches(long relativeZxid, List<String> dataWatches, List<String> existWatches, List<String> childWatches, Watcher var4) {
        for (String path : dataWatches) {
            ...
            if (e != null) {
                ...
                this.dataWatches.addWatch(path, var4);
            }
        }
        ...
        for (String path : childWatches) {
            ...
            if (e != null) {
                ...
                this.childWatches.addWatch(path, var4);
            }
        }
    }
}
