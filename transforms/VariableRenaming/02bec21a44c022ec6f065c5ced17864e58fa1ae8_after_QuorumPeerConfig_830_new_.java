...
public class QuorumPeerConfig {
    ...
    public void parseProperties(Properties zkProp) throws IOException, ConfigException {
        ...
        if (dynamicConfigFileStr == null) {
            ...
            quorumVerifier = parseDynamicConfig(zkProp, electionAlg, true, configBackwardCompatibilityMode);
            checkValidity();
        }
    }
            ...
            new AtomicFileWritingIdiom(new File(configFileStr), new WriterStatement() {
                ...
                public void write(Writer out) throws IOException {
                    for (Entry<Object, Object> entry : cfg.entrySet()) {
                        String var12 = entry.getKey().toString().trim();
                        String value = entry.getValue().toString().trim();
                        if (!var12.startsWith("server.") && !var12.startsWith("group") && !var12.startsWith("weight") && !var12.equals("clientPort") && !var12.equals("clientPortAddress")) {
                            out.write(var12.concat("=").concat(value).concat("\n"));
                        }
                    }
