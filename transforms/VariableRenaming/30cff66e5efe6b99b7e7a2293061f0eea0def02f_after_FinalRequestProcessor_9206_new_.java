                ...
                case OpCode.getData:
                    {
                        ...
                        DataNode var32 = zks.getZKDatabase().getNode(getDataRequest.getPath());
                        if (var32 == null) {
                ...
                case OpCode.getChildren:
                    {
                        ...
                        DataNode var32 = zks.getZKDatabase().getNode(getChildrenRequest.getPath());
                        if (var32 == null) {
                            throw new KeeperException.NoNodeException();
                        }
                        Long aclG;
                ...
                case OpCode.getChildren2:
                    {
                        ...
                        Stat stat = new Stat();
                        DataNode var32 = zks.getZKDatabase().getNode(getChildren2Request.getPath());
                        if (var32 == null) {
                            throw new KeeperException.NoNodeException();
                        }
                        Long aclG;
