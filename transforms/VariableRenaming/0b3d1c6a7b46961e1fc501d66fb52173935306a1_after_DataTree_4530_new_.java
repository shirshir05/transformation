    ...
    public ProcessTxnResult processTxn(TxnHeader header, Record txn) {
        ...
        try {
            ...
            switch(header.getType()) {
                case OpCode.create:
                    CreateTxn var4 = (CreateTxn) txn;
                    debug = "Create transaction for " + var4.getPath();
                    rc.path = var4.getPath();
                    createNode(var4.getPath(), var4.getData(), var4.getAcl(), var4.getEphemeral() ? header.getClientId() : 0, var4.getParentCVersion(), header.getZxid(), header.getTime());
                    break;
                case OpCode.delete:
