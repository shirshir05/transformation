        ...
        try {
            ...
            while (true) {
                ...
                switch(qp.getType()) {
                    ...
                    case Leader.PING:
                        // Process the touches
                        ByteArrayInputStream var34 = new ByteArrayInputStream(qp.getData());
                        DataInputStream dis = new DataInputStream(var34);
                        ...
                        break;
                    case Leader.REVALIDATE:
                        var34 = new ByteArrayInputStream(qp.getData());
                        dis = new DataInputStream(var34);
                        long id = dis.readLong();
                        int to = dis.readInt();
