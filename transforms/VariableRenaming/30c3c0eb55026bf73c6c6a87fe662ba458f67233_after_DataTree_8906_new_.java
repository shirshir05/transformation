    ...
    public ProcessTxnResult processTxn(TxnHeader header, Record txn) {
        ...
        try {
            ...
            switch(header.getType()) {
                case OpCode.create:
                    CreateTxn var3 = (CreateTxn) txn;
                    debug = "Create transaction for " + var3.getPath();
                    createNode(var3.getPath(), var3.getData(), var3.getAcl(), var3.getEphemeral() ? header.getClientId() : 0, header.getZxid(), header.getTime());
                    rc.path = var3.getPath();
                    break;
                case OpCode.delete:
