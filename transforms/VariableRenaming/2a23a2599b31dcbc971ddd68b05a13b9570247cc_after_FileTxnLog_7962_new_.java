...
public class FileTxnLog implements TxnLog {
     ...
     */
    public synchronized boolean append(TxnHeader var0, Record txn) throws IOException {
        if (var0 != null) {
            if (var0.getZxid() <= lastZxidSeen) {
                LOG.warn("Current zxid " + var0.getZxid() + " is <= " + lastZxidSeen + " for " + var0.getType());
            }
            if (logStream == null) {
                logFileWrite = new File(logDir, ("log." + Long.toHexString(var0.getZxid())));
            ...
            padFile(fos);
            byte[] buf = Util.marshallTxnEntry(var0, txn);
