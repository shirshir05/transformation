            ...
            switch(header.getType()) {
                ...
                case OpCode.multi:
                    ...
                    for (Txn subtxn : txns) {
                        ...
                        Record record = null;
                        if (subtxn.getType() == OpCode.create) {
                            record = new CreateTxn();
                        } else if (subtxn.getType() == OpCode.delete) {
                            record = new DeleteTxn();
                        } else if (subtxn.getType() == OpCode.setData) {
                            record = new SetDataTxn();
                        } else if (subtxn.getType() == OpCode.error) {
                            record = new ErrorTxn();
                            post_failed = true;
                        } else if (subtxn.getType() == OpCode.check) {
