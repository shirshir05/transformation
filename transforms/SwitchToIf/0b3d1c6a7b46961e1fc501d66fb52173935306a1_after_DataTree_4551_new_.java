...
public class DataTree {
    ...
    public ProcessTxnResult processTxn(TxnHeader header, Record txn) {
        ...
        try {
            ...
            } else if (header.getType() == OpCode.delete) {
                DeleteTxn deleteTxn = (DeleteTxn) txn;
                debug = "Delete transaction for " + deleteTxn.getPath();
                rc.path = deleteTxn.getPath();
                deleteNode(deleteTxn.getPath(), header.getZxid());
            } else if (header.getType() == OpCode.setData) {
            ...
            } else if (header.getType() == OpCode.setACL) {
                SetACLTxn setACLTxn = (SetACLTxn) txn;
                debug = "Set ACL transaction for " + setACLTxn.getPath();
                rc.stat = setACL(setACLTxn.getPath(), setACLTxn.getAcl(), setACLTxn.getVersion());
            } else if (header.getType() == OpCode.closeSession) {
                killSession(header.getClientId(), header.getZxid());
            } else if (header.getType() == OpCode.error) {
                ErrorTxn errTxn = (ErrorTxn) txn;
                rc.err = errTxn.getErr();
            } else if (header.getType() == OpCode.check) {
                CheckVersionTxn checkTxn = (CheckVersionTxn) txn;
                debug = "Check Version transaction for " + checkTxn.getPath() + " and version=" + checkTxn.getVersion();
                rc.path = checkTxn.getPath();
            } else if (header.getType() == OpCode.multi) {
