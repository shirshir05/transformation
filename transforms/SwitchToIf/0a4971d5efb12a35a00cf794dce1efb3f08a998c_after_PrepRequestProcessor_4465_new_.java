...
public class PrepRequestProcessor extends ZooKeeperCriticalThread implements RequestProcessor {
    ...
    protected void pRequest(Request request) throws RequestProcessorException {
        ...
        request.setTxn(null);
        try {
            if (request.type == OpCode.createContainer) {
            } else if (request.type == OpCode.create) {
            } else if (request.type == OpCode.create2) {
                CreateRequest create2Request = new CreateRequest();
                pRequest2Txn(request.type, zks.getNextZxid(), request, create2Request, true);
            } else if (request.type == OpCode.createTTL) {
                CreateTTLRequest createTtlRequest = new CreateTTLRequest();
                pRequest2Txn(request.type, zks.getNextZxid(), request, createTtlRequest, true);
            } else if (request.type == OpCode.deleteContainer) {
            ...
            } else if (request.type == OpCode.reconfig) {
            ...
            } else if (request.type == OpCode.getChildren2) {
            } else if (request.type == OpCode.ping) {
            } else if (request.type == OpCode.setWatches) {
            } else if (request.type == OpCode.checkWatches) {
            } else if (request.type == OpCode.removeWatches) {
                zks.sessionTracker.checkSession(request.sessionId, request.getOwner());
            } else {
