...
public class LearnerHandler extends Thread {
    ...
    static public String packetToString(QuorumPacket p) {
        ...
        String mess = null;
        Record txn = null;
        if (p.getType() == Leader.ACK) {
            type = "ACK";
        } else if (p.getType() == Leader.COMMIT) {
            type = "COMMIT";
        } else if (p.getType() == Leader.FOLLOWERINFO) {
            type = "FOLLOWERINFO";
        } else if (p.getType() == Leader.NEWLEADER) {
            type = "NEWLEADER";
        } else if (p.getType() == Leader.PING) {
            type = "PING";
        } else if (p.getType() == Leader.PROPOSAL) {
            type = "PROPOSAL";
        ...
        } else if (p.getType() == Leader.REQUEST) {
            type = "REQUEST";
        } else if (p.getType() == Leader.REVALIDATE) {
            type = "REVALIDATE";
        ...
        } else if (p.getType() == Leader.UPTODATE) {
            type = "UPTODATE";
        } else {
